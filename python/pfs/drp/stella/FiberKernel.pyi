...
class BaseKernel:
    ...
    @overload
    def convolve(self, fiberTrace: FiberTrace, bbox: Box2I) -> FiberTrace: ...
    @overload
    def convolve(self, fiberTraces: FiberTraceSet, bbox: Box2I) -> FiberTraceSet: ...
    @overload
    def convolve(self, image: Image) -> Image: ...
    @overload
    def convolve(self, image: MaskedImage, maskThreshold: float = 0.1) -> MaskedImage: ...
    @overload
