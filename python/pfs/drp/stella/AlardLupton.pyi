...
class KernelSolution:
    ...
    def getFirstMoment(self) -> Point2D: ...
    @property
    def firstMoment(self) -> Point2D: ...
    def getSecondMoment(self) -> Quadrupole: ...
    @property
    def secondMoment(self) -> Quadrupole: ...
    def getWeightedSecondMoment(self, windowSigma: float) -> Quadrupole: ...
...
class AlardLuptonResult:
    ...
    def getKernelFirstMoments(self) -> Tuple[np.ndarray, np.ndarray]: ...
    @property
    def kernelFirstMoments(self) -> Tuple[np.ndarray, np.ndarray]: ...
    def getKernelSecondMoments(self) -> Tuple[np.ndarray, np.ndarray, np.ndarray]: ...
    @property
    def kernelSecondMoments(self) -> Tuple[np.ndarray, np.ndarray, np.ndarray]: ...
    def getKernelWeightedSecondMoments(
        self, windowSigma: float
