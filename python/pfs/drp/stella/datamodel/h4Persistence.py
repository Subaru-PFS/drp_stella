...
class H4PersistenceBasicModel(pfs.datamodel.h4Persistence.H4PersistenceBasicModel):
    def update_fractions(
        self,
        fractions: FloatArray1D,
        fraction_errors: FloatArray1D,
        name: str | None = None,
    ) -> "H4PersistenceBasicModel":
        """Return a new H4PersistenceBasicModel with updated fractions; taus, and f_mids unchanged.
        ...
        name : `str` or None, optional
            Name for the new H4PersistenceBasicModel.  Defaults to the current name.

        Returns
        -------
        newmodel : `H4PersistenceBasicModel`
            New model.
        """
        ...
        return H4PersistenceBasicModel(
            new_comps,
    ...
    def fit_fractions(
    ...
    ) -> tuple["H4PersistenceBasicModel", dict]:
        ...
        Returns
        -------
        fitted_det : `H4PersistenceBasicModel`
            New H4PersistenceBasicModel with fitted fractions; taus and f_mids unchanged.
        info : `dict`
    ...
    def summary(self, illum_quartz: Illumination | None = None) -> None:
        ...
        illum_quartz : `Illumination`, optional
            Quartz illumination.
        """
        print(f"H4PersistenceBasicModel: {self.name}")
