...
class DetectorMap:
    ...
    @overload
    def getDispersionAtCenter(self) -> np.ndarray: ...
    @overload
    ...
    @overload
    def getSlope(self, fiberId: int, row: float) -> float: ...
    @overload
    def getSlope(self, fiberId: np.ndarray, row: np.ndarray, calculate: np.ndarray = None) -> np.ndarray: ...
    @overload
    def findFiberId(self, x: float, y: float) -> int: ...
    @overload
    def findFiberId(self, point: Point2D) -> int: ...
    @overload
    def findPoint(
        self, fiberId: int, wavelength: float, throwOnError: bool = False, enforceLimits: bool = True
    ) -> Point2D: ...
    @overload
    ...
    @overload
    def getTracePosition(self, fiberId: int, row: int, halfWidth: int) -> tuple[int, np.ndarray]: ...
    @overload
    def getTracePosition(self, fiberId: int, halfWidth: int) -> list[tuple[int, np.ndarray]]: ...
