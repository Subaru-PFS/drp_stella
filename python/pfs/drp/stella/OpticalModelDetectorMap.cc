...
void declareOpticalModelDetectorMap(py::module_ & mod) {
    ...
    cls.def("getSlitSpatialSpline", &OpticalModelDetectorMap::getSlitSpatialSpline, "fiberId"_a);
    cls.def("getSlitSpectralSpline", &OpticalModelDetectorMap::getSlitSpectralSpline, "fiberId"_a);
