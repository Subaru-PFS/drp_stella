...
//      exit(EXIT_FAILURE);
     ...
     **/
      ...
      string sTemp = "FIBERTRACENUMBER";
      size_t fiberTraceNumber = 0;
      size_t pos_ftn = 0;
      if ((I_Pos = ::pfs::drp::stella::utils::KeyWord_Set(S_A1_Args_In, sTemp)) >= 0)
      {
        #ifdef __DEBUG_MKSLITFUNC__
          cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_Pos = " << I_Pos << endl;
        #endif
        fiberTraceNumber = *(size_t*)ArgV_In[I_Pos];
        cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: KeyWord_Set(FIBERTRACENUMBER): fiberTraceNumber set to " << fiberTraceNumber << endl;
        s_a1(pos_ftn) = "FIBERTRACENUMBER";
        args[pos_ftn] = &fiberTraceNumber;
        #ifdef __DEBUG_MKSLITFUNC__
          cout << "args[" << pos_ftn << "] set to FIBERTRACENUMBER = " << *(unsigned int*)args[pos_ftn] << endl;
        #endif
      }
      ...
      blitz::Array<ImageT, 2> T_A2_PixArray = utils::ndarrayToBlitz(trace->getImage()->getArray());
      blitz::Array<double, 2> D_A2_PixArray = ::pfs::drp::stella::math::Double(T_A2_PixArray);
      #ifdef __DEBUG_MKSLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: D_A2_PixArray.size = " << D_A2_PixArray.rows() << " rows x " << D_A2_PixArray.cols() << " cols" << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: D_A2_PixArray(0,*) = " << D_A2_PixArray(0,blitz::Range::all()) << endl;
      #endif

      blitz::Array<VarianceT, 2> T_A2_Variance = utils::ndarrayToBlitz(trace->getVariance()->getArray());
      #ifdef __DEBUG_MKSLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: T_A2_Variance(0,*) = " << T_A2_Variance(0,blitz::Range::all()) << endl;
      #endif
      ...
      #ifdef __DEBUG_MKSLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: D_A2_Errors(0,*) = " << D_A2_Errors(0,blitz::Range::all()) << endl;
      #endif

      blitz::Array<MaskT, 2> T_A2_MaskArray = utils::ndarrayToBlitz(trace->getMask()->getArray());
      #ifdef __DEBUG_MKSLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: T_A2_MaskArray(0,*) = " << T_A2_MaskArray(0,blitz::Range::all()) << endl;
      #endif
      blitz::Array<int, 2> I_A2_MaskArray(D_A2_PixArray.rows(), D_A2_PixArray.cols());// = ::pfs::drp::stella::math::Int(T_A2_MaskArray);
      ///TODO: use trace->getMask
      I_A2_MaskArray = where(T_A2_MaskArray == 0, 1, 0);
      #ifdef __DEBUG_MKSLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_A2_MaskArray(0,*) = " << I_A2_MaskArray(0,blitz::Range::all()) << endl;
      #endif

      blitz::Array<double, 2> D_A2_ProfArray(trace->getHeight(), trace->getWidth());
  ...
  //    int I_LambdaSP = 1;
      int I_NBins = 0;
      int I_NXSF = 0;
      int I_MaxIterSig = fiberTraceProfileFittingControl->maxIterSig;
      int I_XCorProf = 0;//fiberTraceProfileFittingControl->xCorProf;
      int pos = 0;
  ...
  //    double D_WingSmoothFactor = 0.;
      ...
      #ifdef __DEBUG_MKSLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: telluric set to " << telluric << endl;
      #endif
      ...
      if ((I_Pos = ::pfs::drp::stella::utils::KeyWord_Set(S_A1_Args_In, "BLZ")) >= 0)
      {
        ...
        #ifdef __DEBUG_MKSLITFUNC__
          cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: KeyWord_Set(BLZ): P_D_A1_BLZ set to " << *P_D_A1_BLZ << endl;
        #endif
      }
  ...
  //      B_Run_XCor = true;
      ...
      blitz::Array<double, 1> D_A1_XCorProf_Out(trace->getHeight());
      D_A1_XCorProf_Out = 0.;
      size_t pos_xcorprof = 1;
      size_t pos_xcorprof_out = 2;
      if (I_XCorProf > 0){
        s_a1(pos_xcorprof) = "XCOR_PROF";
        args[pos_xcorprof] = &I_XCorProf;
        #ifdef __DEBUG_FITS_MKSLITFUNC__
        cout << "args[" << pos_xcorprof << "] set to I_XCorProf = " << *(int*)args[pos_xcorprof] << endl;
        #endif

        s_a1(pos_xcorprof_out) = "XCOR_PROF_OUT";
        args[pos_xcorprof_out] = &D_A1_XCorProf_Out;
      }

      size_t pos_sp_out = 3;
      s_a1(pos_sp_out) = "SP_OUT";
      ...
      {
        s_a1(pos_sky) = "SKY";
        s_a1(pos_sp_fit) = "SP_FIT";
      }

      blitz::Array<double, 1> D_A1_Errors_SP_Out(1);

      size_t pos_errors = 8;
      size_t pos_errors_out = 9;
      size_t pos_errors_sp_out = 10;
      size_t pos_err_sky = 11;
      size_t pos_i_bin = 12;
      size_t pos_debugfiles_suffix = 13;
      if (ErrorsRead){
        s_a1(pos_errors) = "ERRORS";
        s_a1(pos_errors_out) = "ERRORS_OUT";
        s_a1(pos_errors_sp_out) = "ERRORS_SP_OUT";
        if (telluric > 1)
        {
          s_a1(pos_err_sky) = "ERR_SKY";
        }
      }
      s_a1(pos_i_bin) = "I_BIN";
      #ifdef __DEBUG_MKSLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: s_a1 = " << s_a1 << endl;
      #endif
      ...
      #endif
      I_NBins = binBoundY.rows();
      cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: binBoundY = " << binBoundY << endl;
      if (binBoundY(binBoundY.rows()-1, 1) != (trace->getHeight()-1)){
        string message("FiberTrace ");
        message += to_string(fiberTraceNumber) + string("::MkSlitFunc: after calculateSwathWidth: ERROR: binBoundY(binBoundY.rows()-1=");
        message += to_string(binBoundY.rows()-1) + string(", 1)=") + to_string(binBoundY(binBoundY.rows()-1, 1));
        message += string("!= (trace->getHeight()-1)=") + to_string(trace->getHeight()-1);
        cout << message << endl;
        throw LSST_EXCEPT(pexExcept::Exception, message.c_str());
      }
      #ifdef __DEBUG_MKSLITFUNC__
      ...
      #ifdef __DEBUG_MKSLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_A2_IBound set to " << binBoundY << endl;
      #endif
      ...
      D_A3_SFSM.resize(trace->getHeight(), trace->getWidth(), I_NBins);

      #ifdef __DEBUG_MKSLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: D_A3_SFSM = " << D_A3_SFSM.rows() << " x " << D_A3_SFSM.cols() << " x " << I_NBins << endl;
      #endif
      D_A3_SFSM = 0.;
      ...
      D_A1_BinCen = 0.5 * (binBoundY(blitz::Range::all(), 0) + binBoundY(blitz::Range::all(),1));
      #ifdef __DEBUG_MKSLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: D_A1_BinCen set to " << D_A1_BinCen << endl;
      #endif
      ...
      I_NXSF = trace->getWidth();//I_A2_MinCenMax(0,2) - I_A2_MinCenMax(0,0) + 1;// - I_NPixCut_Left - I_NPixCut_Right;
      #ifdef __DEBUG_MKSLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_NXSF set to " << I_NXSF << endl;
      #endif

      P_D_A1_BLZ->resize(trace->getHeight());
      (*P_D_A1_BLZ) = 0.;

      D_A2_CCD_Ap.resize(D_A3_SFSM.rows(), D_A3_SFSM.cols());

      D_A2_Err_AllRows.resize(trace->getHeight(), D_A3_SFSM.cols());
      I_A2_Mask_AllRows.resize(trace->getHeight(), D_A3_SFSM.cols());
      I_A2_Mask_AllRows = 1;
      D_A2_Err_AllRows = 0.;
      ...
      for (int I_IBin = 0; I_IBin < I_NBins; I_IBin++) /// Loop thru sf regions
      {
        ...
        I_NR = binBoundY(I_IBin,1) - binBoundY(I_IBin,0) + 1; /// Number of rows (Y-Direction)
        #ifdef __DEBUG_MKSLITFUNC__
          cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": for (I_IBin(=" << I_IBin << ") = 0; I_IBin < I_NBin=" << I_NBins << "; I_IBin++): Resizing D_A2_SlitFunc_Im_In: binBoundY(I_IBin, *) = " << binBoundY(I_IBin, blitz::Range::all()) << ": I_NR set to " << I_NR << endl;
        #endif
        ...
        #ifdef __DEBUG_MKSLITFUNC__
          cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": D_A2_SlitFunc_Im_In initialized to " << D_A2_SlitFunc_Im_In.rows() << " x " << D_A2_SlitFunc_Im_In.cols() << endl;
        #endif

        I_A2_Msk.resize(I_NR, I_NXSF);
        I_A2_Msk = 1;
        #ifdef __DEBUG_MKSLITFUNC__
          cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": for (I_IBin(=" << I_IBin << ") = 0; I_IBin < I_NBin=" << I_NBins << "; I_IBin++): I_A2_Msk initialized to " << I_A2_Msk.rows() << " x " << I_A2_Msk.cols() << endl;
        #endif
        ...
        #ifdef __DEBUG_CHECK_INDICES__
          if (binBoundY(I_IBin, 0) >= binBoundY(I_IBin, 1)){
            std::string message("FiberTrace");
            message += std::to_string(fiberTraceNumber);
            message += std::string("::MkSlitFunc: I_IBin = ");
            message += std::to_string(I_IBin);
            message += std::string(": ERROR: I_A2_IBound(I_IBin, 0)=");
            message += std::to_string(binBoundY(I_IBin, 0));
            message += std::string(" >= I_A2_IBound(I_IBin, 1)=");
            message += std::to_string(binBoundY(I_IBin, 1));
            cout << message << endl;
            throw LSST_EXCEPT(pexExcept::Exception, message.c_str());
          }
        #endif
        #ifdef __DEBUG_CHECK_INDICES__
          if (binBoundY(I_IBin,1) >= trace->getHeight())
          {
            std::string message("FiberTrace");
            message += std::to_string(fiberTraceNumber);
            message += std::string("::MkSlitFunc: I_IBin = ");
            ...
            message += std::to_string(binBoundY(I_IBin,1));
            message += std::string(") >= trace->getHeight(=");
            message += std::to_string(trace->getHeight());
            message += std::string(")");
            cout << message << endl;
            throw LSST_EXCEPT(pexExcept::Exception, message.c_str());
          }
        #endif
        //blitz::Array<double, 1> xCentersTemp(binBoundY(I_IBin,1) - binBoundY(I_IBin,0) + 1);
        //xCentersTemp = D_A1_XCenters(blitz::Range(binBoundY(I_IBin,0), binBoundY(I_IBin,1)));/// USED TO ADD  + 0.5 HERE;
        ///TODO: check for the 0.5
  ///      blitz::Array<double, 1> D_A1_XCentersTemp(xCentersTemp.size());
        ndarray::Array<double, 1, 1> xCentersTemp = pfsDRPStella::math::Double(xCenters);

        xCentersTemp[ndarray::view()] -= math::floor(xCenters, double(0));
        ...
        #endif
        #ifdef __DEBUG_MKSLITFUNC__
          cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": for (int I_IBin(=" << I_IBin << ") = 0; I_IBin < I_NBin(=" << I_NBins << "); I_IBin++): D_A1_XCenMXC set to " << D_A1_XCenMXC << endl;//.transpose(blitz::secondDim, blitz::firstDim) << endl;
        #endif
        ...
        for (int n = 0; n < I_NR; n++)
        {
          ...
          #endif
          #ifdef __DEBUG_CHECK_INDICES__
            if (binBoundY(I_IBin,0) + n >= trace->getHeight())
            {
              std::string message("FiberTrace");
              message += std::to_string(fiberTraceNumber);
              message += std::string("::MkSlitFunc: I_IBin = ");
          ...
          #endif
          D_A1_SSF.resize(trace->getWidth());
          D_A1_Err.resize(trace->getWidth());
          D_A1_Err = D_A2_Errors(binBoundY(I_IBin,0) + n, blitz::Range::all());
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: for (I_IBin(=" << I_IBin << ") = 0; I_IBin < I_NBin=" << I_NBins << "; I_IBin++): for (n(=" << n << ") = 0; n < I_NR(=" << I_NR << "); n++): D_A1_Err set to " << D_A1_Err << endl;
          #endif
          ...
          D_A1_SSF = D_A2_PixArray(binBoundY(I_IBin,0) + n, blitz::Range::all());
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": for (I_IBin(=" << I_IBin << ") = 0; I_IBin < I_NBin=" << I_NBins << "; I_IBin++): for (n(=" << n << ") = 0; n < I_NR(=" << I_NR << "); n++): KeyWord_Set(NO_SCATTER): D_A1_SSF set to " << D_A1_SSF << endl;
          #endif
          #ifdef __DEBUG_CHECK_INDICES__
            if (binBoundY(I_IBin,0)+n >= I_A2_MaskArray.rows())
            {
              std::string message("FiberTrace");
              message += std::to_string(fiberTraceNumber);
              message += std::string("::MkSlitFunc: I_IBin = ");
              message += std::to_string(I_IBin);
              message += std::string(": ERROR: I_A2_IBound(I_IBin,0)+n(=") + std::to_string(binBoundY(I_IBin,0)+n);
          ...
          #endif
          D_A2_CCD_Ap(binBoundY(I_IBin, 0) - binBoundY(0, 0) + n, blitz::Range::all()) = D_A1_SSF;

          #ifdef __DEBUG_CHECK_INDICES__
            if (((binBoundY(I_IBin, 0) + n) < 0) || ((binBoundY(I_IBin, 0) + n) >= I_A2_MaskArray.rows())){
              std::string message("FiberTrace");
              message += std::to_string(fiberTraceNumber);
              message += std::string("::MkSlitFunc: I_IBin = ");
              message += std::to_string(I_IBin);
          ...
          if (max(I_A2_Msk(n, blitz::Range::all())) > 1){
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": I_A2_Msk(n=" << n << ", *) = " << I_A2_Msk(n, blitz::Range::all()) << endl;
            std::string message("FiberTrace");
            message += std::to_string(fiberTraceNumber);
            message += std::string("::MkSlitFunc: I_IBin = ");
            message += std::to_string(I_IBin);
          ...
          if (ErrorsRead){
            D_A2_Err(n, blitz::Range::all()) = D_A1_Err;
              ...
              if ((binBoundY(I_IBin, 0) + n < 0) || (binBoundY(I_IBin, 0) + n >= D_A2_Err_AllRows.rows())){
                std::string message("FiberTrace");
                message += std::to_string(fiberTraceNumber);
                message += std::string("::MkSlitFunc: I_IBin = ");
                message += std::to_string(I_IBin);
                message += std::string(": ERROR: (I_A2_IBound(I_IBin=") + std::to_string(I_IBin) + std::string(", 0)=");
                message += std::to_string(binBoundY(I_IBin, 0)) + std::string(" + n = ") + std::to_string(binBoundY(I_IBin, 0) + n);
            ...
            #endif
            D_A2_Err_AllRows(binBoundY(I_IBin, 0) + n, blitz::Range::all()) = D_A1_Err;
          }
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": for (I_IBin(=" << I_IBin << ") = 0; I_IBin < I_NBin=" << I_NBins << "; I_IBin++): for (n(=" << n << ") = 0; n < I_NR(=" << I_NR << "); n++): D_A2_SlitFunc_Im_In(n, 0) set to " << D_A2_SlitFunc_Im_In(n, 0) << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": for (I_IBin(=" << I_IBin << ") = 0; I_IBin < I_NBin=" << I_NBins << "; I_IBin++): for (n(=" << n << ") = 0; n < I_NR(=" << I_NR << "); n++): D_A2_SlitFunc_Im_In(n, D_A2_SlitFunc_Im_In.cols()-1) set to " << D_A2_SlitFunc_Im_In(n, D_A2_SlitFunc_Im_In.cols()-1) << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": for (I_IBin(=" << I_IBin << ") = 0; I_IBin < I_NBin=" << I_NBins << "; I_IBin++): for (n(=" << n << ") = 0; n < I_NR(=" << I_NR << "); n++): D_A2_SlitFunc_Im_In(n, *) set to " << D_A2_SlitFunc_Im_In(n, blitz::Range::all()) << endl;
          #endif
          #ifdef __DEBUG_CHECK_INDICES__
            if (n >= I_A2_Msk.rows())
            {
        ...
        #endif
        if (max(I_A2_Msk) > 1){
          cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": A. I_A2_Msk = " << I_A2_Msk << endl;
          std::string message("FiberTrace");
          message += std::to_string(fiberTraceNumber);
          message += std::string("::MkSlitFunc: I_IBin = ");
          message += std::to_string(I_IBin);
        ...
        #ifdef __DEBUG_MKSLITFUNC__
          cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": end for: D_A2_Err = " << D_A2_Err << endl;
        #endif
        D_A2_Err_Temp.resize(D_A2_Err.rows(), D_A2_Err.cols());
        D_A2_Err_Temp = D_A2_Err;
        #ifdef __DEBUG_MKSLITFUNC__
          cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": end for: D_A2_SlitFunc_Im_In(*,0) set to " << D_A2_SlitFunc_Im_In(blitz::Range::all(),0) << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": end for: D_A2_SlitFunc_Im_In(*,ncols-1=" << D_A2_SlitFunc_Im_In.cols()-1 << ") set to " << D_A2_SlitFunc_Im_In(blitz::Range::all(),D_A2_SlitFunc_Im_In.cols()-1) << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": end for: I_A2_Msk(*,0) set to " << I_A2_Msk(blitz::Range::all(), 0) << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": end for: I_A2_Msk(*,ncols-1=" << I_A2_Msk.cols()-1 << ") set to " << I_A2_Msk(blitz::Range::all(), I_A2_Msk.cols()-1) << endl;
        ...
        for (int p=0; p<D_A2_SlitFunc_Im_In.rows(); p++)
        {
          ...
          D_A2_SlitFunc_Im_In(p, blitz::Range::all()) = blitz::where(D_A2_SlitFunc_Im_In(p, blitz::Range::all()) < (3. * (0. - fiberTraceProfileFittingControl->ccdReadOutNoise)), 0., D_A2_SlitFunc_Im_In(p, blitz::Range::all()));
        }
        if (telluric == 1)///Piskunov
        {
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": telluric == 1" << endl;
          #endif
          ...
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": telluric = 1: D_A2_SlitFunc_Im_In(*,0) = " << D_A2_SlitFunc_Im_In(blitz::Range::all(),0) << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": telluric = 1: D_A1_Tel set to " << D_A1_Tel.size() << ": " << D_A1_Tel << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": telluric = 1: D_A1_Tel set to " << D_A1_Tel << endl;
          #endif
          I_A1_ITel.resize(D_A1_Tel.size());
          I_A1_ITel = blitz::where(D_A1_Tel <= (max(D_A1_Tel) - min(D_A1_Tel)) / 100. + min(D_A1_Tel), 1, 0);
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": telluric = 1: I_A1_ITel set to " << I_A1_ITel << endl;
          #endif
          ...
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": telluric = 1: D_A2_Tel set to " << D_A2_Tel << endl;
          #endif
          ...
          D_A1_Sky = D_A1_SC;
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": telluric = 1: D_A1_SC set to " << D_A1_SC << endl;
          #endif

          blitz::Array<double, 1> tempDblVecArr = ::pfs::drp::stella::math::Replicate(1., trace->getWidth());// I_A2_MinCenMax(0, 2) - I_A2_MinCenMax(0, 0) + 1);
          #ifdef __DEBUG_CHECK_INDICES__
          ...
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc:  telluric = 1: I_IBin = " << I_IBin << ": I_NR = " << I_NR << ", tempDblVecArr.size() = " << tempDblVecArr.size() << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": telluric = 1: D_A1_SC = " << D_A1_SC << ", VecArrACrossB(D_A1_SC, tempDblVecArr) = " << *p_d2mata << endl;
          #endif
          #ifdef __DEBUG_CHECK_INDICES__
            if (D_A2_SlitFunc_Im_In.rows() != static_cast<int>(D_A1_SC.size()))
            {
              std::string message("FiberTrace");
              message += std::to_string(fiberTraceNumber) + std::string("::MkSlitFunc: I_IBin = ") + std::to_string(I_IBin);
          ...
          #endif
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": telluric = 1: p_d2mata = " << *p_d2mata << endl;
          #endif
          D_A2_SlitFunc_Im_In -= (*p_d2mata);
          delete p_d2mata;
  //        #ifdef __DEBUG_MKSLITFUNC__
  //          cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": KeyWord_Set(TELLURIC): D_A2_SlitFunc_Im_In set to " << D_A2_SlitFunc_Im_In << endl;//.transpose(blitz::secondDim, blitz::firstDim) << endl;
  ...
  //        #endif
          ...
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": I_NR(=" << I_NR << endl;
          #endif
        } /// end if (telluric == 1)
        else if (telluric == 3){
          ...
          if (max(I_A2_Mask_Tel) > 1){
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": 0. I_A2_Mask_TelTemp = " << I_A2_Mask_TelTemp << endl;
            std::string message("FiberTrace");
            message += std::to_string(fiberTraceNumber) + std::string("::MkSlitFunc: I_IBin = ") + std::to_string(I_IBin);
          ...
          for (int p=0; p<D_A2_SlitFunc_Im_In.rows(); p++)
          {
              ...
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": TELLURIC == 3: for(p(=" << p << "); p<D_A2_SlitFunc_Im_In.rows()=" << D_A2_SlitFunc_Im_In.rows() << "; p++): D_A2_SlitFunc_Im_In(p,*) = " << D_A2_SlitFunc_Im_In(p,blitz::Range::all()) << endl;
            #endif
            ...
            #ifdef __DEBUG_TELLURIC__
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": TELLURIC == 3: for(p(=" << p << ")...): D_A2_SlitFunc_Im_In(p,*) = " << D_A2_SlitFunc_Im_In(p,blitz::Range::all()) << endl;
            #endif
            ...
            #ifdef __DEBUG_TELLURIC__
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": TELLURIC == 3: for(p(=" << p << ")...): D_A1_SFMax(p) = " << D_A1_SFMax(p) << endl;
            #endif
          ...
          for (int p=0; p<D_A2_SlitFunc_Im_In.rows(); p++){
            ...
            string S_MySFTemp;
            S_MySF += "MaxOnly_D_A2_SlitFunc_Im_In_Norm_IBin" + to_string(I_IBin) + "Tel3.fits";
            ::pfs::drp::stella::utils::WriteFits(&D_A2_SlitFunc_Im_In, S_MySF);
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": TELLURIC == 3: File " << S_MySF << " written" << endl;
          #endif
          /// /////////////////////////////////////////////////////////////////////////
          ...
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": TELLURIC == 3: while: Median(D_A1_SFMax) = " << ::pfs::drp::stella::math::Median(D_A1_SFMax) << endl;
          #endif
          ...
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: D_A1_SFMax = " << D_A1_SFMax << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: D_MedianSFMax = " << D_MedianSFMax << endl;
          #endif
          ...
          #ifdef __DEBUG_TELLURIC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: nind_temp = " << nind_temp << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": TELLURIC == 3: while: I_A1_IndA set to " << I_A1_IndA << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": TELLURIC == 3: while: *P_I_A1_Ind set to " << *P_I_A1_Ind << endl;
          #endif
          ...
          #ifdef __DEBUG_TELLURIC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": TELLURIC == 3: while: D_A1_SFMax set to " << D_A1_SFMax << endl;
          #endif
          ...
          I_A2_Mask_TelTemp = 0;
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": 1. I_A2_Mask_Tel = " << I_A2_Mask_Tel << endl;
          #endif
          if (max(I_A2_Mask_Tel) > 1){
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": 1A. I_A2_Mask_TelTemp = " << I_A2_Mask_TelTemp << endl;
            std::string message("FiberTrace");
            message += std::to_string(fiberTraceNumber) + std::string("::MkSlitFunc: I_IBin = ") + std::to_string(I_IBin);
          ...
          D_A1_SFMax_SumRows = blitz::sum(D_A2_SlitFunc_Im_In_Times_Mask(j,i),j);
            ...
            if (B_MaximaOnly){
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: B_MaximaOnly: D_A1_SFMax_SumRows = " << D_A1_SFMax_SumRows << endl;
          ...
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": 2. I_A2_Mask_TelTemp = " << I_A2_Mask_TelTemp << endl;
          #endif
          I_A2_Mask_Tel = I_A2_Mask_TelTemp;
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": 3. I_A2_Mask_Tel = " << I_A2_Mask_Tel << endl;
          #endif
          if (max(I_A2_Mask_Tel) > 1){
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": 3A. I_A2_Mask_TelTemp = " << I_A2_Mask_TelTemp << endl;
            std::string message("FiberTrace");
            message += std::to_string(fiberTraceNumber) + std::string("::MkSlitFunc: I_IBin = ") + std::to_string(I_IBin);
          ...
          #ifdef __DEBUG_MKSLITFUNC__
            D_A2_TempIm.resize(D_A2_SlitFunc_Im_In.rows(), D_A2_SlitFunc_Im_In.cols());
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": D_A2_SlitFunc_Im_In = " << D_A2_SlitFunc_Im_In << endl;
        ...
        I_RunMax = 1;
        if (telluric > 2){
          I_RunMax = fiberTraceProfileFittingControl->maxIterSky;
          I_MaxIterSig = 0;
          B_MaximaOnly = true;
        }
        I_Run_Tel = 0;
        ...
        do{
          ...
          D_A1_SP_Out = 0.;
          args[pos_sp_out] = &D_A1_SP_Out;

          I_Stop = 0;
          args[pos_stop] = &I_Stop;
          ...
          args[pos_mask] = &I_A2_Mask_Temp;
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": I_A2_Mask_Temp = " << I_A2_Mask_Temp << endl;//.transpose(blitz::secondDim, blitz::firstDim) << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": args[" << pos_mask << "] set to " << *((blitz::Array<int, 2>*)(args[pos_mask])) << endl;
          #endif
          ...
          if (telluric > 1)
          {
            ...
            D_A1_Sky_Temp = 0.;
            args[pos_sky] = &D_A1_Sky_Temp;
            D_A1_SPFit.resize(D_A2_SlitFunc_Im_In_Tel.rows());
            D_A1_SPFit = 0.;
            args[pos_sp_fit] = &D_A1_SPFit;
          }

          if (ErrorsRead){
            args[pos_errors] = &D_A2_Err;
            #ifdef __DEBUG_MKSLITFUNC__
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": D_A2_Err = " << D_A2_Err << endl;
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": args[" << pos_errors << "] set to " << *((blitz::Array<double, 2>*)(args[pos_errors])) << endl;
            #endif

            D_A1_ErrOut.resize(D_A2_SlitFunc_Im_In_Tel.rows());
            D_A1_ErrOut = 0.;
            args[pos_errors_out] = &D_A1_ErrOut;
            #ifdef __DEBUG_MKSLITFUNC__
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": D_A1_ErrOut = " << D_A1_ErrOut << endl;
            #endif

            D_A1_Errors_SP_Out.resize(D_A2_SlitFunc_Im_In_Tel.rows());
            D_A1_Errors_SP_Out = 0.;
            args[pos_errors_sp_out] = &D_A1_Errors_SP_Out;
            #ifdef __DEBUG_MKSLITFUNC__
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": D_A1_Errors_SP_Out = " << D_A1_Errors_SP_Out << endl;
            #endif
            ...
            if (telluric > 1)
            {
              ...
              D_A1_ErrSky = 0.;
              args[pos_err_sky] = &D_A1_ErrSky;
            }
          }

          args[pos_i_bin] = &I_IBin;
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << endl;//.transpose(blitz::secondDim, blitz::firstDim) << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": args[" << pos_i_bin << "] set to " << *((int*)(args[pos_i_bin])) << endl;
          #endif

          s_a1(pos_debugfiles_suffix) = "DEBUGFILES_SUFFIX";
          S_SF_DebugFilesSuffix = "trace";
          ...
          args[pos_debugfiles_suffix] = &S_SF_DebugFilesSuffix;

          cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: fiberTraceNumber = " << fiberTraceNumber << ", I_IBin = " << I_IBin << ": starting SlitFunc" << endl;
          #ifdef __DEBUG_MKSLITFUNC__
            if (I_IBin < 100)
            {
              S_TempNum = "0";
          ...
          #endif
          if (!pfsDRPStella::math::SlitFunc(D_A2_SlitFunc_Im_In_Tel,
                                            I_MaxIterSig,
                                            D_A1_XCenMXC,
          ...
          #endif
          #ifdef __DEBUG_SLITFUNC_FILES__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: fiberTraceNumber = " << fiberTraceNumber << ", I_IBin = " << I_IBin << ": D_A1_SP = " << D_A1_SP << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: fiberTraceNumber = " << fiberTraceNumber << ", I_IBin = " << I_IBin << ": D_A1_SP_Out = " << D_A1_SP_Out << endl;
          #endif
          if (ErrorsRead){
            #ifdef __DEBUG_SLITFUNC_FILES__
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: fiberTraceNumber = " << fiberTraceNumber << ", I_IBin = " << I_IBin << ": D_A1_Errors_SP_Out = " << D_A1_Errors_SP_Out << endl;
            #endif
            blitz::Array<double, 1> D_A1_SNR(D_A1_SP.size());
            D_A1_SNR = D_A1_SP_Out / D_A1_Errors_SP_Out;
            #ifdef __DEBUG_SLITFUNC_FILES__
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: fiberTraceNumber = " << fiberTraceNumber << ", I_IBin = " << I_IBin << ": D_A1_SNR = " << D_A1_SNR << endl;
            #endif
          }
          #ifdef __DEBUG_MKSLITFUNC__
          ...
          if (!B_MaximaOnly){
            #ifdef __DEBUG_SLITFUNC_FILES__
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: !B_MaximaOnly: After SlitFunc: I_A2_Mask = " << I_A2_Mask <<  endl;
            #endif
          }

          cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: fiberTraceNumber = " << fiberTraceNumber << ", I_IBin = " << I_IBin << ": SlitFunc ready" << endl;
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_IBin = " << I_IBin << ": D_A2_SFSM = " << D_A2_SFSM << endl;
            if (ErrorsRead)
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_IBin = " << I_IBin << ": After SlitFunc: D_A2_Err = " << D_A2_Err << endl;
          #endif
          if (!B_MaximaOnly){
            #ifdef __DEBUG_CHECK_INDICES__
              ...
              if (binBoundY(I_IBin, 1) - binBoundY(0,0) - (binBoundY(I_IBin, 0) - binBoundY(0,0)) + 1 != D_A2_SFSM.rows()){
                std::string message("FiberTrace");
                message += std::to_string(fiberTraceNumber) + std::string("::MkSlitFunc: I_IBin = ") + std::to_string(I_IBin);
                message += std::string(": ERROR: binBoundY(I_IBin, 1) - binBoundY(0,0) - (binBoundY(I_IBin, 0) - binBoundY(0,0)) + 1 (=");
                message += to_string(binBoundY(I_IBin, 1) - binBoundY(0,0) - (binBoundY(I_IBin, 0) - binBoundY(0,0)) + 1);
                message += string(") != D_A2_SFSM.rows()=") + to_string(D_A2_SFSM.rows());
                cout << message << endl;
                throw LSST_EXCEPT(pexExcept::Exception, message.c_str());
              }
            #endif
            D_A3_SFSM(blitz::Range(binBoundY(I_IBin, 0) - binBoundY(0,0), binBoundY(I_IBin, 1) - binBoundY(0,0)), blitz::Range::all(), I_IBin) = D_A2_SFSM;

            D_A2_SP(blitz::Range(binBoundY(I_IBin, 0) - binBoundY(0,0), binBoundY(I_IBin, 1) - binBoundY(0,0)), I_IBin) = D_A1_SP;

            if (ErrorsRead)
              D_A2_Errors_SP_Out(blitz::Range(binBoundY(I_IBin, 0) - binBoundY(0,0), binBoundY(I_IBin, 1) - binBoundY(0,0)), I_IBin) = D_A1_Errors_SP_Out;
              ...
              if (max(I_A2_Mask(i_row, blitz::Range::all())) == 1){
                for (int i_col=0; i_col<I_A2_Mask.cols(); i_col++){
                  if (I_A2_Mask(i_row, i_col) == 0)
                    I_A2_MaskArray(int(binBoundY(I_IBin, 0))+i_row, i_col) = I_A2_Mask(i_row, i_col);
                }
                #ifdef __DEBUG_MKSLITFUNC__
                  cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_A2_MaskArray(" << binBoundY(I_IBin, 0)+i_row << ", *) = " << I_A2_MaskArray(binBoundY(I_IBin, 0)+i_row, blitz::Range::all()) << endl;
                #endif
              }
            }
            if (telluric == 1){
              D_A2_Sky(blitz::Range(binBoundY(I_IBin, 0) - binBoundY(0,0), binBoundY(I_IBin, 1) - binBoundY(0,0)), I_IBin) = D_A1_Sky;
              if (ErrorsRead)
                D_A2_ErrSky(blitz::Range(binBoundY(I_IBin, 0) - binBoundY(0,0), binBoundY(I_IBin, 1) - binBoundY(0,0)), I_IBin) = D_A1_ErrSky;
            }
          }/// end if (!B_MaximaOnly)
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": fiberTraceNumber = " << fiberTraceNumber << ", IBin = " << I_IBin << ": D_A2_SFSM set to " << D_A2_SFSM << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": fiberTraceNumber = " << fiberTraceNumber << ", IBin = " << I_IBin << ": D_A1_SP set to " << D_A1_SP << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": fiberTraceNumber = " << fiberTraceNumber << ", IBin = " << I_IBin << ": I_A2_Mask_Temp set to " << I_A2_Mask_Temp << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": SlitFunc ready" << endl;

            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": After SlitFunc: D_A1_SP = " << D_A1_SP << endl;

            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": After SlitFunc: D_A2_SFSM = " << D_A2_SFSM << endl;

            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": After SlitFunc: D_A2_SFSM = Im_Out = " << D_A2_SFSM << endl;
          ...
          if (telluric == 3){/// Subtract minimum of each row > 0. from Slit Function
            ...
            for (int q=0; q<D_A2_SFSM.rows(); q++){
              ...
              #ifdef __DEBUG_MKSLITFUNC__
                cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": D_Sum_D_A2_SFSM = " << D_Sum_D_A2_SFSM << endl;
                cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": D_A2_SFSM(q=" << q << ", *) set to " << D_A2_SFSM(q, blitz::Range::all()) << endl;
              #endif
          ...
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": I_Run_Tel = " << I_Run_Tel << ": D_SFDev = " << D_SFDev << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": I_Run_Tel = " << I_Run_Tel << ": mean(D_A2_SlitFunc_Im_In_Tel) / 1000. = " << mean(D_A2_SlitFunc_Im_In_Tel) / 1000. << endl;
          #endif
          D_A2_SFOld = D_A2_SFSM;

          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": Before Fit: 1. D_A2_Err = " << D_A2_Err << endl;
          #endif
          #ifdef __DEBUG_CHECK_INDICES__
            if (binBoundY(I_IBin, 1) - binBoundY(I_IBin, 0) + 1 != I_A2_Mask.rows()){
              std::string message("FiberTrace");
              message += std::to_string(fiberTraceNumber) + std::string("::MkSlitFunc: I_IBin = ") + std::to_string(I_IBin);
              message += std::string(": ERROR: I_A2_IBound(I_IBin, 1) - I_A2_IBound(I_IBin, 0) + 1(=") + to_string(binBoundY(I_IBin, 1) - binBoundY(I_IBin, 0) + 1);
            ...
            if (I_A2_Mask_AllRows.cols() != I_A2_Mask.cols()){
              ...
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": D_A2_SFSM.cols() = " << D_A2_SFSM.cols() << endl;
              cout << message << endl;
              throw LSST_EXCEPT(pexExcept::Exception, message.c_str());
            }
          #endif
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": I_Run_Tel = " << I_Run_Tel << ": I_IBin = " << I_IBin << ", I_A2_IBound = " << binBoundY.rows() << " x " << binBoundY.cols() << ", I_A2_IBound(I_IBin, *) = " << binBoundY(I_IBin, blitz::Range::all()) << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": I_Run_Tel = " << I_Run_Tel << ": I_IBin = " << I_IBin << ", I_A2_Mask_AllRows = " << I_A2_Mask_AllRows.rows() << " x " << I_A2_Mask_AllRows.cols() << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": I_Run_Tel = " << I_Run_Tel << ": I_IBin = " << I_IBin << ", I_A2_Mask = " << I_A2_Mask.rows() << " x " << I_A2_Mask.cols() << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: Before Fit: 2. D_A2_Err = " << D_A2_Err << endl;
          #endif

          #ifdef __DEBUG_CHECK_INDICES__
            if (binBoundY(I_IBin, 0) < 0){
              std::string message("FiberTrace");
              message += std::to_string(fiberTraceNumber) + std::string("::MkSlitFunc: I_IBin = ") + std::to_string(I_IBin);
              message += std::string(": ERROR: I_A2_IBound(I_IBin=") + to_string(I_IBin) + string(", 0) = ") + to_string(binBoundY(I_IBin, 0));
              message += string(" < 0");
              cout << message << endl;
              throw LSST_EXCEPT(pexExcept::Exception, message.c_str());
            }
            if (binBoundY(I_IBin, 1) >= I_A2_Mask_AllRows.rows()){
              std::string message("FiberTrace");
              message += std::to_string(fiberTraceNumber) + std::string("::MkSlitFunc: I_IBin = ") + std::to_string(I_IBin);
              message += std::string(": ERROR: I_A2_IBound(I_IBin=") + to_string(I_IBin) + string(", 1) = ") + to_string(binBoundY(I_IBin, 1));
            ...
            if (binBoundY(I_IBin, 1) - binBoundY(I_IBin, 0) + 1 != I_A2_Mask.rows()){
              ...
              message += std::to_string(fiberTraceNumber) + std::string("::MkSlitFunc: I_IBin = ") + std::to_string(I_IBin);
              message += std::string(": ERROR: I_A2_IBound(I_IBin=") + to_string(I_IBin) + string(", 1)(=") + to_string(binBoundY(I_IBin, 1));
              message += string(") - I_A2_IBound(I_IBin, 0)(=") + to_string(binBoundY(I_IBin, 0)) + string(") + 1 = ");
              message += to_string(binBoundY(I_IBin, 1) - binBoundY(I_IBin, 0) + 1) + string(" != I_A2_Mask.rows()=");
          ...
          #endif
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_A2_Mask = " << I_A2_Mask << endl;
          #endif
          if (!B_MaximaOnly){
            for (int i_row=0; i_row<I_A2_Mask.rows(); i_row++){
              #ifdef __DEBUG_MKSLITFUNC__
                cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_A2_Mask_AllRows(" << binBoundY(I_IBin, 0)+i_row << ", *) = " << I_A2_Mask_AllRows(binBoundY(I_IBin, 0)+i_row, blitz::Range::all()) << endl;
              #endif
              for (int i_col=0; i_col<I_A2_Mask.cols(); i_col++){
                if (I_A2_Mask(i_row, i_col) == 0)
                  I_A2_Mask_AllRows(int(binBoundY(I_IBin, 0))+i_row, i_col) = 0;
              }
              #ifdef __DEBUG_MKSLITFUNC__
                cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_A2_Mask_AllRows(" << binBoundY(I_IBin, 0)+i_row << ", *) = " << I_A2_Mask_AllRows(binBoundY(I_IBin, 0)+i_row, blitz::Range::all()) << endl;
              #endif
          ...
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": I_A2_Mask_AllRows(blitz::Range(" << binBoundY(I_IBin, 0) << ", " << binBoundY(I_IBin, 1) << "), blitz::Range::all()) set to I_A2_Mask = " << I_A2_Mask << endl;
          #endif

          D_A2_Err.resize(D_A2_Err_Temp.rows(), D_A2_Err_Temp.cols());
          D_A2_Err = D_A2_Err_Temp;
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": Before Fit: 4. D_A2_Err = " << D_A2_Err << endl;
          #endif
          if ((I_Run_Tel == (I_RunMax-1)) || (D_SFDev < mean(D_A2_SFSM) / 5000000.)){
            #ifdef __DEBUG_MKSLITFUNC__
              if (D_SFDev < mean(D_A2_SlitFunc_Im_In_Tel) / 5000000.){
                if (B_MaximaOnly)
                  cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": B_MaximaOnly==TRUE: D_SFDev = " << D_SFDev << ": mean(D_A2_SFSM) = " << mean(D_A2_SFSM) << endl;
                else
                  cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": D_SFDev = " << D_SFDev << ": mean(D_A2_SFSM) = " << mean(D_A2_SFSM) << endl;
              }
            #endif
            if (B_MaximaOnly){
              B_MaximaOnly = false;
              I_MaxIterSig = fiberTraceProfileFittingControl->maxIterSig;
              if (telluric == 3){
                I_Run_Tel = -1;
                D_SFDev = 1.;
                I_A2_Mask_Tel = I_A2_Msk;
                I_A2_Mask_Temp = I_A2_Msk;
                #ifdef __DEBUG_MKSLITFUNC__
                  cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": I_A2_Mask_Tel set to " << I_A2_Mask_Tel << endl;
                #endif
                D_A2_SlitFunc_Im_In = D_A2_SlitFuncOrig;
                D_A2_SlitFunc_Im_In_Tel = D_A2_SlitFuncOrig;
                #ifdef __DEBUG_MKSLITFUNC__
                  cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": D_A2_SlitFunc_Im_In_Tel set to " << D_A2_SlitFunc_Im_In_Tel << endl;
                #endif
                D_A1_Sky = 0.;
                #ifdef __DEBUG_MKSLITFUNC__
                  cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": D_A2_SFSM = " << D_A2_SFSM << endl;
                #endif
              }
              else{
                I_Run_Tel = I_RunMax;
          ...
          if (telluric == 3){
            ...
            if (ErrorsRead){
              ...
              #ifdef __DEBUG_MKSLITFUNC__
                cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": Just before Fit: D_A2_Err = " << D_A2_Err << endl;
              #endif
            }
            ...
            #ifdef __DEBUG_MKSLITFUNC__
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": Just before Fit: I_A2_Mask = " << I_A2_Mask << endl;
            #endif
            ...
            #ifdef __DEBUG_MKSLITFUNC__
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": min(D_A2_SlitFunc_Im_In_Tel) = " << min(D_A2_SlitFunc_Im_In_Tel) << endl;
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": Just before Fit: D_A2_SFSM = " << D_A2_SFSM << endl;
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": Just before Fit: D_A2_SlitFuncOrig = " << D_A2_SlitFuncOrig << endl;
            #endif
            ...
            if (!::pfs::drp::stella::math::LinFitBevington(D_A2_SlitFuncOrig,      ///: in
              ...
              #ifdef __DEBUG_MKSLITFUNC__
                cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": Just after Fit: D_A2_SFSM = " << D_A2_SFSM << endl;
              #endif
  ...
  //            #endif
              ...
              for (int tttt=0; tttt<D_A2_SlitFunc_Im_In_Tel.rows(); tttt++){
                ...
                if (D_ImMin < 0. - (3. * fiberTraceProfileFittingControl->ccdReadOutNoise)){
                  D_ImMin = D_ImMin + (3. * fiberTraceProfileFittingControl->ccdReadOutNoise);
                  #ifdef __DEBUG_MKSLITFUNC__
                    cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": tttt=" << tttt << ": D_ImMin = " << D_ImMin << endl;
                    cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": tttt=" << tttt << ": D_A2_SlitFunc_Im_In_Tel(tttt,*) = " << D_A2_SlitFunc_Im_In_Tel(tttt, blitz::Range::all()) << endl;
                    cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": tttt=" << tttt << ": D_A1_Sky(tttt) = " << D_A1_Sky(tttt) << endl;
                  #endif
                  D_A2_SlitFunc_Im_In_Tel(tttt, blitz::Range::all()) -= D_ImMin;
                  #ifdef __DEBUG_MKSLITFUNC__
                    cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": tttt=" << tttt << ": D_A2_SlitFunc_Im_In_Tel(tttt,*) set to " << D_A2_SlitFunc_Im_In_Tel(tttt, blitz::Range::all()) << endl;
                  #endif
                  D_A1_Sky(tttt) += D_ImMin;
                  #ifdef __DEBUG_MKSLITFUNC__
                    cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": tttt=" << tttt << ": D_A1_Sky(tttt) set to " << D_A1_Sky(tttt) << endl;
                  #endif
                }
              }
              ...
              #ifdef __DEBUG_MKSLITFUNC__
                cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": I_Run_Tel = " << I_Run_Tel << ": after sky subtraction: min(D_A2_SlitFunc_Im_In_Tel) = " << min(D_A2_SlitFunc_Im_In_Tel) << endl;
              #endif
          ...
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": I_Run_Tel = " << I_Run_Tel << endl;
          #endif
          I_Run_Tel++;
        ...
        for (int q=0; q < static_cast<int>(D_A1_SP.size()); q++){
          ...
          #ifdef __DEBUG_MKSLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": I_A2_Msk(q=" << q << ", blitz::Range::all()) = " << I_A2_Msk(q,blitz::Range::all()) << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: I_IBin = " << I_IBin << ": max(I_A2_Msk(q=" << q << ", blitz::Range::all())) = " << max(I_A2_Msk(q,blitz::Range::all())) << endl;
          #endif
      ...
      #endif
      D_A1_Sky.resize(binBoundY(I_NBins-1,1) - binBoundY(0,0) + 1);
      D_A1_ErrSky.resize(binBoundY(I_NBins-1,1) - binBoundY(0,0) + 1);
      D_A1_SP.resize(binBoundY(I_NBins-1,1) - binBoundY(0,0) + 1);

      D_A1_Errors_SP_Out.resize(binBoundY(I_NBins-1,1) - binBoundY(0,0) + 1);

      D_A2_SF.resize(binBoundY(I_NBins-1,1) - binBoundY(0,0) + 1, trace->getWidth());
      #ifdef __DEBUG_CHECK_INDICES__
        if (static_cast<int>(D_A1_SP.size()) != D_A2_SP.rows()){
          std::string message("FiberTrace");
          message += std::to_string(fiberTraceNumber) + std::string("::MkSlitFunc: ERROR: D_A1_SP.size(=") + to_string(D_A1_SP.size()) + string(") != D_A2_SP.rows(= ") + to_string(D_A2_SP.rows());
          message += string(")");
          cout << message << endl;
          throw LSST_EXCEPT(pexExcept::Exception, message.c_str());
        }
        ...
        if (D_A2_SF.rows() != D_A3_SFSM.rows()){
          std::string message("FiberTrace");
          message += std::to_string(fiberTraceNumber) + std::string("::MkSlitFunc: ERROR: D_A2_SF.rows(=") + to_string(D_A2_SF.rows()) + string(") != D_A3_SFSM.rows(= ");
        ...
        if (D_A2_SF.cols() != D_A3_SFSM.cols()){
          std::string message("FiberTrace");
          message += std::to_string(fiberTraceNumber) + std::string("::MkSlitFunc: ERROR: D_A2_SF.cols(=") + to_string(D_A2_SF.cols()) + string(") != D_A3_SFSM.cols(= ");
  ...
  //      int I_Row_Rel=0;
        ...
        for (int i_row = 0; i_row < D_A3_SFSM.rows(); i_row++){
          ...
          if ((I_Bin == 0) && (i_row < binBoundY(1, 0))){
          ...
          else if ((I_Bin == I_NBins-1) && (i_row >= binBoundY(I_Bin-1, 1))){// && (i_row > (I_A2_IBound(I_Bin-1, 1) - (I_A2_IBound(0,1) / 2.)))){
            ...
            D_Weight_Bin0 = 1. - D_Weight_Bin1;
              ...
              if (i_row >= D_A2_SP.rows()){
                std::string message("FiberTrace");
                message += std::to_string(fiberTraceNumber) + std::string("::MkSlitFunc: i_row = ") + to_string(i_row) + string(": I_Bin = ") + std::to_string(I_Bin);
              ...
              if (I_Bin + 1 >= D_A2_SP.cols()){
                std::string message("FiberTrace");
                message += std::to_string(fiberTraceNumber) + std::string("::MkSlitFunc: I_Bin = ") + std::to_string(I_Bin);
            ...
            #endif
            #ifdef __DEBUG_MKSLITFUNC__
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: i_row = " << i_row << ": I_Bin = " << I_Bin << ": D_A2_SP(i_row, I_Bin) = " << D_A2_SP(i_row, I_Bin) << ", D_A2_SP(i_row, I_Bin + 1) = " << D_A2_SP(i_row, I_Bin + 1) << endl;
            #endif
            D_A1_SP(i_row) = (D_A2_SP(i_row, I_Bin) * D_Weight_Bin0) + (D_A2_SP(i_row, I_Bin + 1) * D_Weight_Bin1);
            #ifdef __DEBUG_MKSLITFUNC__
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: i_row = " << i_row << ": I_Bin = " << I_Bin << ": D_A1_SP(" << i_row << ") set to " << D_A1_SP(i_row) << endl;
            #endif
            ...
            #ifdef __DEBUG_MKSLITFUNC__
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: D_A3_SFSM(i_row, *, I_Bin) = " << D_A3_SFSM(i_row, blitz::Range::all(), I_Bin) << ", D_A3_SFSM(i_row, *, I_Bin+1) = " << D_A3_SFSM(i_row, blitz::Range::all(), I_Bin+1) << endl;
            #endif
            ...
            #ifdef __DEBUG_MKSLITFUNC__
              cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: i_row = " << i_row << ": I_Bin = " << I_Bin << ": D_A2_SF(" << i_row << ", *) set to " << D_A2_SF(i_row, blitz::Range::all()) << endl;
            #endif
      ...
      #ifdef __DEBUG_MKSLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::MkSlitFunc: D_A2_SF set to " << D_A2_SF << endl;
      #endif
  ...
  //    if (!_isImageSet){
  //      cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: ERROR: _image is not set" << endl;
  //      return false;
  //    }
      int Pos = 0;    
      ...
      if (Pos >= 0)
      {
        ...
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_A2_ImM = " << D_A2_ImM << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: xCentersPixelFraction_In = " << xCentersPixelFraction_In << endl;
      #endif
      ...
      int I_Bin = 0;
  //    #ifdef __DEBUG_SLITFUNC__
  //      cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": D_A2_ImM = " << D_A2_ImM << endl;
  ...
  //    #endif
      ...
      int overSample_In = fiberTraceProfileFittingControl->overSample;
      int I_NPixSlitF, TempInt, TempIntA;
  ...
  //    ILastVecArr = 0;
      ...
      *P_D_A2_Errors = blitz::sqrt(blitz::where(D_A2_Im > 0., D_A2_Im, 1.));
      ...
      double Lamb_SF = fiberTraceProfileFittingControl->lambdaSF;
      double D_WingSmoothFactor = fiberTraceProfileFittingControl->wingSmoothFactor;
      double Lamb_SP = fiberTraceProfileFittingControl->lambdaSP;
      #ifdef __PISKUNOV_ORIG__
        double D_XLow = D_A2_Im.rows() / 2.;
      #endif
      #ifdef __DEBUG_SLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: Lamb_SF = " << Lamb_SF << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: Lamb_SP = " << Lamb_SP << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_WingSmoothFactor = " << D_WingSmoothFactor << endl;
      #endif
      ...
      if (Pos >= 0)
      {
        ...
        #ifdef __DEBUG_SLITFUNC__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: I_Bin set to " << I_Bin << endl;
        #endif
      }
  ...
  //      cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_XLow set to " << D_XLow << endl;
  //    }
  ...
  //      #ifdef __DEBUG_SLITFUNC__
  //        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: KeyWord_Set(ERRORS): Pos = " << Pos << endl;
  //        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: KeyWord_Set(ERRORS): S_A1_Args_In = " << S_A1_Args_In << endl;
  //        return false;
  //      #endif
        if (Pos >= 0)
        {
          ...
          #ifdef __DEBUG_SLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: *P_D_A2_Errors = " << *P_D_A2_Errors << endl;
          #endif
  //        return false;
        }
      ...
      if ((I_Pos = ::pfs::drp::stella::utils::KeyWord_Set(S_A1_Args_In, "XCOR_PROF")) >= 0)
      {
        ...
        if ((I_XCorProf > 0) && (I_XCorProf < 5))
          I_XCorProf = 5;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(XCOR_PROF): I_XCorProf set to " << I_XCorProf << endl;
      }
      else{
  ...
  //      cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": XCenVecArr = " << XCenVecArr << endl;
      ...
      if (overSample_In < 1)
        overSample_In = 1;
      #ifdef __DEBUG_SLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": overSample_In = " << overSample_In << endl;
      #endif
      ...
      if ((Pos = ::pfs::drp::stella::utils::KeyWord_Set(S_A1_Args_In, "MASK")) >= 0)
      {
        ...
        #ifdef __DEBUG_SLITFUNC__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(MASK): P_I_A2_Mask read = " << *P_I_A2_Mask << endl;
        #endif
        if (max(*P_I_A2_Mask) > 1){
          string message("FiberTrace");
          message += to_string(fiberTraceNumber) + string("::SlitFunc: fiberTraceNumber = ") + to_string(fiberTraceNumber) + string(": I_Bin = ") + to_string(I_Bin);
        ...
        if (P_I_A2_Mask->size() != 1)
        {
            ...
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(MASK): (*P_I_A2_Mask) set to " << (*P_I_A2_Mask) << endl;
          #endif
      ...
      {
        #ifdef __DEBUG_SLITFUNC_N__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": !KeyWord_Set(MASK): D_A2_Im.rows = " << I_NRows_Im << ", D_A2_Im.cols = " << I_NCols_Im << endl;
        #endif
        if (I_NCols_Im < 0)
        {
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": !KeyWord_Set(MASK): D_A2_Im = " << D_A2_Im << endl;
        }
      ...
      if ((Pos = ::pfs::drp::stella::utils::KeyWord_Set(S_A1_Args_In, "PROF_OUT")) >= 0)
      {
        ...
        #ifdef __DEBUG_SLITFUNC_N__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): P_D_A2_Prof_Out read " << endl;// to " << *P_D_A2_Prof_Out << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): P_D_A2_Prof_Out->size() = " << P_D_A2_Prof_Out->size() << endl;// to " << *P_D_A2_Prof_Out << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): P_D_A2_Prof_Out->rows() = " << P_D_A2_Prof_Out->rows() << endl;// to " << *P_D_A2_Prof_Out << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): P_D_A2_Prof_Out->cols() = " << P_D_A2_Prof_Out->cols() << endl;// to " << *P_D_A2_Prof_Out << endl;
        #endif
      }
      #ifdef __DEBUG_SLITFUNC__
      ...
      (*P_D_A2_Prof_Out) = 0.;
      #ifdef __DEBUG_SLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): P_D_A2_Prof_Out resized to (" << I_NRows_Im << ", " << I_NCols_Im << ")" << endl;
      #endif
      double D_SFMax = 0.;
      ...
      #ifdef __DEBUG_SLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Telluric set to " << I_Telluric << endl;
      #endif
      if (I_Telluric == 2)
      {
        #ifdef __DEBUG_TELLURIC__
          cout << "__TELLURIC_MINE__ set" << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: S_A1_Args_In = " << S_A1_Args_In << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: S_A1_Args_In(0) = " << S_A1_Args_In(0) << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: S_A1_Args_In(1) = " << S_A1_Args_In(1) << endl;
        #endif
        ...
        #ifdef __DEBUG_TELLURIC__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC = 2: D_A2_MySF.size() = " << D_A2_MySF << endl;
        #endif
        D_A2_MySF = D_A2_Im;
        #ifdef __DEBUG_TELLURIC__
          string S_MySF = DEBUGDIR + std::string("D_A2_Im") + debugFilesSuffix + std::string(".fits");
          ::pfs::drp::stella::utils::WriteFits(&D_A2_Im, S_MySF);
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: File " << S_MySF << " written" << endl;
        #endif
        for (int p=0; p<I_NRows_Im; p++)
        {
          #ifdef __DEBUG_TELLURIC__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: for(p(=" << p << "); p<D_A2_MySF.rows()=" << D_A2_MySF.rows() << "; p++): D_A2_Im(p,*) = " << D_A2_Im(p,blitz::Range::all()) << endl;
          #endif

          /// Set MySF to 0. where < 3.*(-RON)
          D_A2_MySF(p, blitz::Range::all()) = blitz::where(D_A2_MySF(p, blitz::Range::all()) < (0. - (3. * fiberTraceProfileFittingControl->ccdReadOutNoise)), 0., D_A2_MySF(p, blitz::Range::all()));
          ...
          #ifdef __DEBUG_TELLURIC__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: for(p(=" << p << ")...): D_A2_MySF(p,*) = " << D_A2_MySF(p,blitz::Range::all()) << endl;
          #endif
          ...
          #ifdef __DEBUG_TELLURIC__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: for(p(=" << p << ")...): D_A1_SFMax(p) = " << D_A1_SFMax(p) << endl;
          #endif
        ...
        do
        {
          ...
          #ifdef __DEBUG_TELLURIC__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: while: D_DevTemp set to " << D_DevTemp << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: while: Median(D_A1_SFMax) = " << ::pfs::drp::stella::math::Median(D_A1_SFMax) << endl;
          #endif
          I_A1_IndA.resize(D_A1_SFMax.size());
          ...
          #ifdef __DEBUG_TELLURIC__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: while: I_A1_IndA set to " << I_A1_IndA << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: while: *P_I_A1_Ind set to " << *P_I_A1_Ind << endl;
          #endif
          ...
          *P_D_A1_SFMax = D_A1_SFMax;
          ...
          delete(P_D_A1_SFMax);
          #ifdef __DEBUG_TELLURIC__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: while: D_A1_SFMax set to " << D_A1_SFMax << endl;
          #endif
          ...
          #ifdef __DEBUG_TELLURIC__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: while: D_A2_MySF_Max set to " << D_A2_MySF_Max << endl;
        ...
        #ifdef __DEBUG_TELLURIC__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: D_SFMax = " << D_SFMax << endl;
        #endif
        ...
        ::pfs::drp::stella::math::GetSubArrCopy(D_A2_MySF_MaxTemp,
                                          *P_I_A1_SFMaxInd,
                                          ...
                                          D_A2_MySF_Max);
        #ifdef __DEBUG_TELLURIC__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: P_I_A1_SFMaxInd set to " << *P_I_A1_SFMaxInd << endl;
        ...
        #ifdef __DEBUG_TELLURIC__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: D_A1_MySF set to " << D_A1_MySF << endl;
        #endif
        ...
        delete(P_D_A2_MySF);
        #ifdef __DEBUG_TELLURIC__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: D_A2_MySF set to " << D_A2_MySF << endl;
        ...
        {
          #ifdef __DEBUG_SLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": MEASURE_ERRORS_IN set to " << *P_D_A2_Errors << endl;
          #endif
        ...
        D_A2_ImBak = D_A2_Im;
        #ifdef __DEBUG_TELLURIC__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: D_A2_Im = " << D_A2_Im << endl;
        #endif

        D_A1_Sky = 1.;
        #ifdef __DEBUG_TELLURIC__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: D_A2_Im = " << D_A2_Im << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: (*P_I_A2_Mask) = " << (*P_I_A2_Mask) << endl;
        #endif
        D_A2_ImTimesMask = D_A2_Im * (*P_I_A2_Mask);
        D_A2_SFTimesMask = D_A2_MySF * (*P_I_A2_Mask);
        #ifdef __DEBUG_TELLURIC__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: D_A2_ImTimesMask = " << D_A2_ImTimesMask << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: D_A2_SFTimesMask = " << D_A2_SFTimesMask << endl;
        #endif
        ...
        #ifdef __DEBUG_TELLURIC__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: after Fit: D_A1_MySP = " << D_A1_MySP << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: after Fit: D_A1_Sky = " << D_A1_Sky << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: after Fit: D_A1_ChiSquare_LinFit = " << D_A1_ChiSquare_LinFit << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: after Fit: D_A1_Probability_LinFit = " << D_A1_Probability_LinFit << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: after Fit: D_A2_Sigma_LinFit = " << D_A2_Sigma_LinFit << endl;
        #endif
        ...
        #ifdef __DEBUG_TELLURIC__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: D_A1_MySP set to " << D_A1_MySP << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TELLURIC == 2: *P_D_A1_MySky set to " << *P_D_A1_MySky << endl;
        ...
        for (int p=0; p < static_cast<int>(P_D_A1_MySky->size()); p++)
        {
          ...
          D_A2_Im(p,blitz::Range::all()) = blitz::where(D_A2_Im(p,blitz::Range::all()) < 0. - (3. * fiberTraceProfileFittingControl->ccdReadOutNoise), 0., D_A2_Im(p,blitz::Range::all()));
      ...
      #ifdef __DEBUG_SLITFUNC_N__
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": Weight = " << Weight << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": UseRowVecArr = " << UseRowVecArr << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": OIndVecArr = " << OIndVecArr << endl;
      #endif
      ...
      #ifdef __DEBUG_SLITFUNC_N__
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_NPixSlitF set to " << I_NPixSlitF << endl;
      #endif
      ...
      if ((Pos = ::pfs::drp::stella::utils::KeyWord_Set(S_A1_Args_In, "BAD")) >= 0)
      {
        ...
        #ifdef __DEBUG_SLITFUNC_N__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(BAD): P_I_A1_JBadVecArr set to " << *P_I_A1_JBadVecArr << endl;
        #endif
      ...
      if ((Pos = ::pfs::drp::stella::utils::KeyWord_Set(S_A1_Args_In, "USE_ROWS")) >= 0)
      {
        ...
        #ifdef __DEBUG_SLITFUNC_N__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(USE_ROW): ArgV_In[Pos=" << Pos << "]=" << *(int*)(ArgV_In[Pos]) << " => UseRowVecArr set to " << UseRowVecArr << endl;
        #endif
        ...
        #ifdef __DEBUG_SLITFUNC_N__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": D_A2_Im = " << D_A2_Im << endl;
        #endif
        ...
        (*P_I_A2_Mask) = I_A2_MaskUseRow;
          ...
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": (*P_I_A2_Mask) = " << (*P_I_A2_Mask) << endl;
        #endif
      ...
      if (Pos < 0)// || (Pos >= 0 && TempIntB == 0))
      {
        ...
        UseRowVecArr = i;
        #ifdef __DEBUG_SLITFUNC_N__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": !KeyWord_Set(USE_ROW): UseRowVecArr set to " << UseRowVecArr << endl;
        #endif
      }
      ...
      #ifdef __DEBUG_SLITFUNC_N__
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": Norm set to " << Norm << endl;
      #endif
      ...
      if (I_Telluric != 2)
      {
          ...
          SFVecArr = blitz::sum(D_A2_ImTimesMask_Guess(j,i),j);
            ...
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: PiskunovOrig: 1. SFVecArr set to " << SFVecArr << endl;
          #endif
          #ifdef __DEBUG_SLITFUNC_FILES__
          ...
          SFVecArr = SFVecArr / blitz::sum(SFVecArr);
            ...
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: PiskunovOrig: 2. SFVecArr set to " << SFVecArr << endl;
          #endif
          ...
          #ifdef __DEBUG_SLITFUNC_PISKUNOV__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: PiskunovOrig: 1. spectrum_Out set to " << spectrum_Out << endl;
          #endif
          spectrum_Out = (spectrum_Out / blitz::sum(spectrum_Out)) * blitz::sum(D_A2_Im * (*P_I_A2_Mask));
          #ifdef __DEBUG_SLITFUNC_PISKUNOV__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: PiskunovOrig: 2. spectrum_Out set to " << spectrum_Out << endl;
          #endif
          P_D_A2_Mat = ::pfs::drp::stella::math::VecArrACrossB(spectrum_Out, SFVecArr);
          #ifdef __DEBUG_SLITFUNC_PISKUNOV__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: PiskunovOrig: (*P_D_A2_Mat) set to " << *P_D_A2_Mat << endl;
          #endif
          D_Dev = sqrt(blitz::sum((*P_I_A2_Mask) * blitz::pow2(D_A2_Im - (*P_D_A2_Mat))) / double(blitz::sum(*P_I_A2_Mask)));
          #ifdef __DEBUG_SLITFUNC_PISKUNOV__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: PiskunovOrig: D_Dev set to " << D_Dev << endl;
          #endif
          int I_NBad = 0;
          ...
          for (int i_row = 0; i_row < D_A2_Im.rows(); i_row++){
            ...
            #ifdef __DEBUG_SLITFUNC_PISKUNOV__
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: PiskunovOrig: i_row = " << i_row << ": D_A1_WhereDev = " << D_A1_WhereDev  << endl;
            #endif
            ...
            if (I_NBad > 0){
              for (int i_ind = 0; i_ind < I_NBad; i_ind++){
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: PiskunovOrig: i_row = " << i_row << ": i_ind = " << i_ind << ": (*P_I_A1_WhereDev)(i_ind) = " << (*P_I_A1_WhereDev)(i_ind)  << endl;
                #endif
          ...
          #ifdef __DEBUG_SLITFUNC_PISKUNOV__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: PiskunovOrig: (*P_I_A2_Mask) set to " << *P_I_A2_Mask << endl;
          #endif
          D_A2_ImTimesMask_Guess = D_A2_Im * (*P_I_A2_Mask);
          #ifdef __DEBUG_SLITFUNC_FILES__
          ...
          #ifdef __DEBUG_SLITFUNC_N__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": D_A2_ImTimesMask = " << D_A2_ImTimesMask << endl;
          #endif
          ...
          {
            #ifdef __DEBUG_SLITFUNC_N__
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": WARNING: blitz::sum(SFVecArr) == 0 => Setting to 1." << endl;
            #endif
            SFVecArr = 1.;
          }
          ...
          #ifdef __DEBUG_SLITFUNC_N__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": 3.    Slit Function SFVecArr = SFVecArr / (blitz::sum(SFVecArr) = " << blitz::sum(SFVecArr) << ") = " << SFVecArr << endl;
          #endif
          ...
          #ifdef __DEBUG_SLITFUNC_A__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": (*P_I_A2_Mask) = " << (*P_I_A2_Mask) << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TempArray = ImM*(*P_I_A2_Mask) = " << TempArray << endl;
          #endif
          ...
          TempArray *= (*p_d2mat);
          #ifdef __DEBUG_SLITFUNC_N__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": TempArray = TempArray*(VecArrACrossB(Replicate(1.,D_A2_Im.rows(=" << I_NRows_Im << "))=" << d1rep << ", SFVecArr(=" << SFVecArr << "))=" << *p_d2mat << ") = " << TempArray << endl;
          #endif
          delete p_d2mat;
          ...
          #endif
          #ifdef __DEBUG_SLITFUNC_N__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": -3. spectrum_Out (set to blitz::sum(D_A2_Im * (*P_I_A2_Mask), j)) = " << spectrum_Out << endl;
          #endif
          spectrum_Out *= Norm;
          ...
          #endif
          #ifdef __DEBUG_SLITFUNC_N__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": -2. spectrum_Out (*Norm=" << Norm << ") = " << spectrum_Out << endl;
          #endif

          spectrum_Out = blitz::where(spectrum_Out < 0., 0., spectrum_Out);
          #ifdef __DEBUG_SLITFUNC_N__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": -1. spectrum_Out (*Norm=" << Norm << ") = " << spectrum_Out << endl;
          #endif
          spectrum_Out /= blitz::sum(spectrum_Out);
          #ifdef __DEBUG_SLITFUNC_N__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": 0. spectrum_Out (set to /=blitz::sum(spectrum_Out)) = " << spectrum_Out << endl;
          #endif
          ...
          {
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": WARNING: blitz::sum(spectrum_Out=" << spectrum_Out << ") == 0" << endl;
            spectrum_Out = 1.;
          }
          #ifdef __DEBUG_SLITFUNC_N__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": blitz::sum(spectrum_Out) =" << blitz::sum(spectrum_Out) << endl;
          #endif
          ...
          #endif
          #ifdef __DEBUG_SLITFUNC_N__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": spectrum_Out (set to *=blitz::sum(D_A2_Im * (*P_I_A2_Mask))(=" << blitz::sum(D_A2_Im * (*P_I_A2_Mask)) << ")) = " << spectrum_Out << endl;
          #endif
        #endif
      }/// end if (I_Telluric != 2)
      ...
      if (Pos >= 0)
      {
        ...
        D_A1_Dev = Dev;
        #ifdef __DEBUG_SLITFUNC_N__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(NOISE): Dev set to " << Dev << endl;
        #endif
      ...
      #ifdef __DEBUG_SLITFUNC_N__
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": 1. spectrum_Out = " << spectrum_Out << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": SFVecArr = " << SFVecArr << endl;
      #endif
      #ifdef __DEBUG_CHECK_INDICES__
        if (D_A2_Im.cols() != static_cast<int>(SFVecArr.size())){
          string message("FiberTrace");
          message += to_string(fiberTraceNumber) + string("::SlitFunc: ERROR: D_A2_Im.cols() != SFVecArr.size()");
          cout << message << endl;
          throw LSST_EXCEPT(pexExcept::Exception, message.c_str());    
        }
      #endif
      ...
      if (I_Telluric == 1 || I_Telluric == 3)
        B_WithSky = false;
      #ifdef __DEBUG_SLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: Before FitSig: SFVecArr = " << SFVecArr << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_A2_Im = " << D_A2_Im << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: *p_SFArr = " << *p_SFArr << endl;
        if (B_WithSky)
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: B_WithSky = true" << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_Reject = " << D_Reject << endl;
        if (ErrorsRead)
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: *P_D_A2_Errors = " << *P_D_A2_Errors << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: I_A2_MaskFit = " << I_A2_MaskFit << endl;
      #endif
      if (!::pfs::drp::stella::math::LinFitBevington(D_A2_Im,
                                               *p_SFArr,
                                               ...
                                               PP_Void_FitSig)){
        string message("FiberTrace");
        message += to_string(fiberTraceNumber) + string("::SlitFunc: ERROR: FitSig returned FALSE");
        cout << message << endl;
        throw LSST_EXCEPT(pexExcept::Exception, message.c_str());    
      }
      *P_I_A2_Mask = I_A2_MaskFit;
        ...
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: After FitSig: I_A2_MaskFit = " << I_A2_MaskFit << endl;
      #endif
      delete(p_SFArr);
      free(PP_Void_FitSig);
      ...
      #ifdef __DEBUG_SLITFUNC_N__
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": 2c.    Slit Function SFVecArr = SFVecArr / (blitz::sum(SFVecArr) = " << blitz::sum(SFVecArr) << ") = " << SFVecArr << endl;
      #endif
      ...
      SFVecArr /= blitz::sum(SFVecArr);           /** Slit Function **/
      #ifdef __DEBUG_SLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: c) SFVecArr = " << SFVecArr << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_A1_SP_Tmp = " << D_A1_SP_Tmp << endl;
      #endif
      ...
      *p_tempMat = D_A2_Im - (*p_tempMatA);
      ...
      #endif
      #ifdef __DEBUG_SLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": !KeyWord_Set(NOISE): *p_tempMatA " << *p_tempMatA << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": !KeyWord_Set(NOISE): *p_tempMat " << *p_tempMat << endl;
      #endif
      ...
      for (unsigned int iter_sig = 0; iter_sig < maxIterSig_In; iter_sig++)
      {
        ::pfs::drp::stella::math::Double((*P_I_A2_Mask), D_A2_Mask);
          ...
          if (P_I_A2_Mask->rows() != D_A2_Mask.rows()){
            string message("FiberTrace");
            message += to_string(fiberTraceNumber) + string("::SlitFunc: ERROR: 1. P_I_A2_Mask->rows() != D_A2_Mask.rows()");
            cout << message << endl;
            throw LSST_EXCEPT(pexExcept::Exception, message.c_str());    
          }
        #endif
        ...
        if (Pos < 0 || (Pos >= 0 && abs(Dev) < 0.00000000000000001))
        {
          for (int i_col=0; i_col < static_cast<int>(D_A2_Im.cols()); i_col++){
            if (blitz::sum((*P_I_A2_Mask)(blitz::Range::all(), i_col)) == 0){
              ...
              if (fabs(blitz::sum(D_A2_Mask)) < 0.000000000001){
                string message("FiberTrace");
                message += to_string(fiberTraceNumber) + string("::SlitFunc: fiberTraceNumber = ") + to_string(fiberTraceNumber) + string(": I_Bin = ");
          ...
          #ifdef __DEBUG_SLITFUNC_N__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": !KeyWord_Set(NOISE): iter_sig = " << iter_sig << ": D_A1_Dev set to " << D_A1_Dev << endl;
          #endif
        }
        else{
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: KeyWord_Set(NOISE): D_A1_Dev = " << D_A1_Dev << endl;
        }
        ...
        ::pfs::drp::stella::math::Double((*P_I_A2_Mask), D_A2_Mask);
          ...
          if (P_I_A2_Mask->rows() != D_A2_Mask.rows()){
            string message("FiberTrace");
            message += to_string(fiberTraceNumber) + string("::SlitFunc: ERROR: 0. P_I_A2_Mask->rows() != D_A2_Mask.rows()");
            cout << message << endl;
            throw LSST_EXCEPT(pexExcept::Exception, message.c_str());    
          }
        #endif
        ...
        for (int i_col = 0; i_col < D_A2_Im.cols(); i_col++){
          #ifdef __DEBUG_SLITFUNC_N__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": iter_sig = " << iter_sig << ": (*p_tempMatB)(blitz::Range::all(), i_col=" << i_col << ") = " << (*p_tempMatB)(blitz::Range::all(), i_col) << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": iter_sig = " << iter_sig << ": D_A1_Dev(i_col=" << i_col << ") = " << D_A1_Dev(i_col) << endl;
          #endif
            ...
            if (maxIterSig_In > 0){
              ...
              #ifdef __DEBUG_SLITFUNC_N__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": iter_sig = " << iter_sig << ": (*P_I_A2_Mask)(blitz::Range::all(), i_col=" << i_col << ") = " << (*P_I_A2_Mask)(blitz::Range::all(), i_col) << endl;
              #endif
            }
          #endif
        }///end for (int i_col = 0; i_col < D_A2_Im.cols(); i_col++){
        #ifdef __DEBUG_SLITFUNC__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": iter_sig = " << iter_sig << ": (*P_I_A2_Mask) = " << (*P_I_A2_Mask) << endl;
        #endif
        ::pfs::drp::stella::math::Double((*P_I_A2_Mask), D_A2_Mask);
        #ifdef __DEBUG_CHECK_INDICES__
          if (P_I_A2_Mask->rows() != D_A2_Mask.rows()){
            string message("FiberTrace");
            message += to_string(fiberTraceNumber) + string("::SlitFunc: ERROR: P_I_A2_Mask->rows() != D_A2_Mask.rows()");
            cout << message << endl;
            throw LSST_EXCEPT(pexExcept::Exception, message.c_str());    
          }
          for (int i_row=0; i_row<P_I_A2_Mask->rows(); i_row++){
            for (int i_col=0; i_col<P_I_A2_Mask->cols(); i_col++){
              if ((*P_I_A2_Mask)(i_row, i_col) != int(D_A2_Mask(i_row, i_col))){
                string message("FiberTrace");
                message += to_string(fiberTraceNumber) + string("::SlitFunc: ERROR: (*P_I_A2_Mask)(i_row, i_col)(=") + to_string((*P_I_A2_Mask)(i_row, i_col));
          ...
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": D_A2_Im[" << D_A2_Im.rows() << ", " << D_A2_Im.cols() << "]" << ", p_tempMatA[" << p_tempMatA->rows() << ", " << p_tempMatA->cols() << "]" << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": D_A2_Im - spectrum_Out x SFVecArr = " << D_A2_ImTemp << endl;
        #endif
  ...
  //    XVecArr = (i + 0.5) / double(overSample_In) - 1.;
  //    #ifdef __DEBUG_SLITFUNC_X__
  //      cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": XVecArr = " << XVecArr << endl;
  //    #endif
      BKLIndVecArr.resize(overSample_In + 1);
      BKLIndVecArr = i;
      BKLIndVecArr += (I_NPixSlitF * overSample_In);
      #ifdef __DEBUG_SLITFUNC_N__
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": BKLIndVecArr = " << BKLIndVecArr << endl;
      #endif
      ...
      #ifdef __DEBUG_SLITFUNC_N__
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": OLIndVecArr = " << OLIndVecArr << endl;
      #endif
      ...
      for (long m=overSample_In + 1; m <= (2 * overSample_In); m++)
      {
        ...
        #ifdef __DEBUG_SLITFUNC_N__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": for(m=" << m << "): mm = " << mm << endl;
        #endif
        ...
        #ifdef __DEBUG_SLITFUNC_N__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": for(m=" << m << "): TempIVecArr = " << TempIVecArr << endl;
        #endif

        int oldsize = BKLIndVecArr.size();
        #ifdef __DEBUG_SLITFUNC_N__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": for(m=" << m << "): oldsize(BKLIndVecArr) = " << oldsize << endl;
        #endif
  ...
  //      #ifdef __DEBUG_SLITFUNC_X__
  //        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": for(m=" << m << "): BKLIndVecArr = " << BKLIndVecArr << endl;
  //      #endif

        oldsize = OLIndVecArr.size();
        #ifdef __DEBUG_SLITFUNC_N__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": for(m=" << m << "): oldsize(OLIndVecArr) = " << oldsize << endl;
        #endif
      ...
      SPOldVecArr = 0.;
      #ifdef __DEBUG_SLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": SPOldVecArr = " << SPOldVecArr << endl;
      #endif
      ...
      for (int m = 0; m < I_NRows_Im; m++)  /** Fill up matrix and RHS **/
      {
        ...
        #ifdef __DEBUG_SLITFUNC_N__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): TempIVecArr set to " << TempIVecArr << endl;
        #endif
        ::pfs::drp::stella::math::GetIndex(TempIVecArr, NInd, IndVecArr);
        #ifdef __DEBUG_SLITFUNC_N__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): NInd = " << NInd << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): IndVecArr set to " << IndVecArr << endl;
        #endif
        I_A1_IFirstPix(m) = IndVecArr(0);

        #ifdef __DEBUG_SLITFUNC_N__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): I_A1_IFirstPix(" << m << ") = " << I_A1_IFirstPix(m) << endl;
        #endif
        I_A1_ILastPix(m)  = IndVecArr(NInd - 1);
        #ifdef __DEBUG_SLITFUNC_N__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): I_A1_ILastPix(" << m << ") = " << I_A1_ILastPix(m) << endl;
        #endif

        #ifdef __DEBUG_SLITFUNC__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): D_A2_XX(m,*) = " << D_A2_XX(m,blitz::Range::all()) << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): D_A2_Im->cols = " << I_NCols_Im << endl;
        #endif

        TempIVecArr = blitz::where((D_A2_XX(m,blitz::Range::all()) >= 0.) && (D_A2_XX(m,blitz::Range::all()) < (double)(I_NCols_Im)), 1, 0);

        #ifdef __DEBUG_SLITFUNC__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): TempIVecArr(where) = " << TempIVecArr << endl;
        #endif
        ...
        #ifdef __DEBUG_SLITFUNC__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): I_A1_IFirstSpec(m) set to " << I_A1_IFirstSpec(m) << endl;
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): I_A1_ILastSpec(m) set to " << I_A1_ILastSpec(m) << endl;
        #endif
      ...
      {
        D_A1_XProf(mm) = double(mm) + 0.5 + (1. / (2. * static_cast<double>(fiberTraceProfileFittingControl->overSample)));
      }
      ...
      do
      {
        I_Iter_Sky++;
      /// fit spline3?
        /*if (fiberTraceProfileFittingControl->profileInterpolation.compare(fiberTraceProfileFittingControl->PROFILE_INTERPOLATION_NAMES[1]) == 0){
  ...
  //                       I_A1_IFirstPix,
                         ...
                         profile_Out)){
            string message("FiberTrace");
            message += to_string(fiberTraceNumber) + "::SlitFunc: I_Bin = " + to_string(I_Bin) + ": ERROR: fitSpline returned FALSE";
            cout << message << endl;
            throw LSST_EXCEPT(pexExcept::Exception, message.c_str());    
          }
          ...
          D_A1_SFO = SFVecArr;
          #ifdef __DEBUG_SLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: I_Bin = " << I_Bin << ": SFVecArr = " << SFVecArr << endl;
          #endif
          ...
          #ifdef __DEBUG_SLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: I_Bin = " << I_Bin << ": D_A1_SFO = " << D_A1_SFO << endl;
          #endif
        }
        else{/// Piskunov*/
          I_Iter_SF = 0;
          while(I_Iter_SF < static_cast<int>(fiberTraceProfileFittingControl->maxIterSF))   /** Iteration counter **/
          {
            I_Iter_SF++;

            #ifdef __DEBUG_SLITFUNC_PISKUNOV__
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": (max(abs(spectrum_Out - SPOldVecArr=" << SPOldVecArr << ") / max(spectrum_Out)=" << max(spectrum_Out) << ")=" << max(fabs(spectrum_Out - SPOldVecArr) / max(spectrum_Out)) << endl;
            #endif
            ...
            if ((I_Iter_SF == 1) || (max(fabs(spectrum_Out - SPOldVecArr) / max(spectrum_Out)) > 0.00001))
            {
              ...
              AKLArr = 0.;
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": if(max...): AKLArr initialized to 0.: size(AKLArr) = (" << AKLArr.rows() << "," << AKLArr.cols() << ")" << endl;
              #endif

              BLVecArr.resize(I_NPixSlitF);                      /** and RHS **/
              BLVecArr = 0.;
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": if(max...): BLVecArr = " << BLVecArr << endl;
              #endif

              OmegaVecArr.resize(overSample_In + 1);
              OmegaVecArr = Weight;                    /** Replicate constant Weights **/
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": if(max...): OmegaVecArr = " << OmegaVecArr << endl;
              #endif
              ...
              {
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": Begin for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++)" << endl;
                #endif
                ...
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): OmegaVecArr(0) set to " << OmegaVecArr(0) << endl;
                #endif

                OmegaVecArr(overSample_In) = 1. - D_A2_XX(m, I_A1_ILastPix(m));
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): OmegaVecArr(overSample_In=" << overSample_In << ") set to " << OmegaVecArr(overSample_In) << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): OmegaVecArr set to " << OmegaVecArr << endl;
                #endif
                ...
                delete p_OArr;
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): 1. OArr set to " << OArr << endl;//.transpose(blitz::secondDim,blitz::firstDim) << endl;
                #endif

                tmpdbl = OArr(overSample_In, overSample_In);
                tmpdbl += OArr(0, 0);
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): tmpdbl set to " << tmpdbl << endl;
                #endif
                OArr(overSample_In, overSample_In) = tmpdbl;
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): OArr(overSample_In=" << overSample_In << ", overSample_In) set to " << OArr(overSample_In, overSample_In) << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): OArr = " << OArr << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): OLIndVecArr = " << OLIndVecArr << endl;
                #endif
                ...
                for (unsigned int n = 0; n < OLIndVecArr.size(); n++)
                {
                  ...
                  #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                    cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): for (int n(=" << n << ") = 0; n < OLIndVecArr.size(=" << OLIndVecArr.size() << "); n++): setting OOVecArr(n) to OArr(OLIndVecArr(temprow(=" << temprow << "), tempcol(=" << tempcol << "))=" << OArr(temprow, tempcol) << endl;
                  #endif
                  #ifdef __DEBUG_CHECK_INDICES__
                ...
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): OOVecArr set to " << OOVecArr << endl;
                #endif
                ...
                for (int n = 0; n < I_NCols_Im; n++)
                {
                  ...
                  {
                    #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                      cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": n(=" << n << ") * overSample_In(=" << overSample_In << ") + I_A1_IFirstPix(m)(=" << I_A1_IFirstPix(m) << ") + BKLIndVecArr(o=" << o << ")=" << BKLIndVecArr(o) << " = " << (n * overSample_In) + I_A1_IFirstPix(m) + BKLIndVecArr(o) << endl;
                      cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": BKLIndVecArr = " << BKLIndVecArr << endl;
                      cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": OOVecArr = " << OOVecArr << endl;
                    #endif
                    ...
                    temprow = ::pfs::drp::stella::math::GetRowFromIndex((n * overSample_In) + I_A1_IFirstPix(m) + BKLIndVecArr(o), BKLArr.rows());
                      ...
                      {
                        string message("FiberTrace");
                        message += to_string(fiberTraceNumber) + "::SlitFunc: fiberTraceNumber = " + to_string(fiberTraceNumber) + ": I_Bin = " + to_string(I_Bin);
                ...
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): BKLArr set to " << BKLArr << endl;//.transpose(blitz::secondDim,blitz::firstDim) << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): OOVecArr set to " << OOVecArr << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): BKLArr set to " << BKLArr << endl;//.transpose(blitz::secondDim,blitz::firstDim) << endl;
                #endif
    ...
    //            OOVecArr.resize(1);
                ...
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): OOVal set to " << OOVal << endl;
                #endif
                ...
                for (int o = 0; o < overSample_In; o++)
                {
                  ...
                  #endif
                  #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                    cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): for(o(=" << o << ")=0; o<overSample_In(=" << overSample_In << "); o++): BKLARR(blitz::Range = (overSample_In - o = " << overSample_In - o << ", " << endl;
                ...
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): BKLArr set to " << BKLArr << endl;//.transpose(blitz::secondDim,blitz::firstDim) << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): AKLArr = " << AKLArr << endl;//.transpose(blitz::secondDim,blitz::firstDim) << endl;
                  ...
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): D_SPVecPow(= " << D_SPVecPow << ") * BKLArr(= " << BKLArr << ") = " << D_A2_SPVecTimesBKLArr << endl;
                #endif
                #ifdef __DEBUG_CHECK_INDICES__
                ...
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): AKLArr(+= (pow(spectrum_Out(m), 2) * BKLArr)) set to " << AKLArr << endl;//.transpose(blitz::secondDim,blitz::firstDim) << endl;
                #endif
                ...
                for (int n = 0; n < I_NCols_Im; n++)
                {
                ...
                #ifdef __DEBUG_SLITFUNC_FILES__
                  //cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): 2. OArr set to " << OArr << endl;
                  //cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): D_A2_Im(m,*) = " << D_A2_Im(m, blitz::Range::all()) << endl;
                  ...
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": Writing file " << sOArr << endl;
                  ...
                  if (P_I_A2_Mask->rows() != D_A2_Mask.rows()){
                    string message("FiberTrace");
                    message += to_string(fiberTraceNumber) + "::SlitFunc: ERROR: 2. P_I_A2_Mask->rows() != D_A2_Mask.rows()";
                    cout << message << endl;
                    throw LSST_EXCEPT(pexExcept::Exception, message.c_str());    
                  }
                #endif
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): 3. OArr set to " << OArr << endl;//.transpose(blitz::secondDim,blitz::firstDim) << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): *P_I_A2_Mask = " << *P_I_A2_Mask << endl;//.transpose(blitz::secondDim,blitz::firstDim) << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): D_A2_Mask = " << D_A2_Mask << endl;//.transpose(blitz::secondDim,blitz::firstDim) << endl;
                #endif

                for (int n = 1; n < I_NCols_Im; n++)
                {
                  #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                    cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): for(n(=" << n << ")=1; n<NCols(=" << I_NCols_Im << "); n++): (D_A2_Im(m,n-1)=" << D_A2_Im(m, n-1) << ")" << endl;
                    cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): for(n(=" << n << ")=1; n<NCols(=" << I_NCols_Im << "); n++): ((*P_I_A2_Mask)(m,n-1)=" << (*P_I_A2_Mask)(m, n-1) << ")" << endl;
                    cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): for(n(=" << n << ")=1; n<NCols(=" << I_NCols_Im << "); n++): OmegaVecArr(overSample_In)=" << OmegaVecArr(overSample_In) << ")" << endl;
                    cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): for(n(=" << n << ")=1; n<NCols(=" << I_NCols_Im << "); n++): (D_A2_Im(m,n)=" << D_A2_Im(m, n) << ")" << endl;
                    cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): for(n(=" << n << ")=1; n<NCols(=" << I_NCols_Im << "); n++): ((*P_I_A2_Mask)(m,n)=" << (*P_I_A2_Mask)(m, n) << ")" << endl;
                    cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): for(n(=" << n << ")=1; n<NCols(=" << I_NCols_Im << "); n++): (OmegaVecArr(0)=" << OmegaVecArr(0) << ")" << endl;
                  #endif
                  ...
                  #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                    cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): for(n(=" << n << ")=1; n<NCols(=" << I_NCols_Im << "); n++): OArr((n * overSample_In) + I_A1_IFirstPix(m)=" << (n * overSample_In) + I_A1_IFirstPix(m) << ", 0) set to " << OArr((n * overSample_In) + I_A1_IFirstPix(m), 0) << endl;
                  #endif
                }/// end for (int n = 1; n < I_NCols_Im; n++)
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): 4. OArr set to " << OArr << endl;//.transpose(blitz::secondDim,blitz::firstDim) << endl;
                #endif
                OArr(I_A1_IFirstPix(m), 0) = D_A2_Im(m, 0) * OmegaVecArr(0) * D_A2_Mask(m, 0);
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): D_A2_Im(m, I_NCols_Im-1) = " << D_A2_Im(m, I_NCols_Im-1) << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): OmegaVecArr(overSample_In) = " << OmegaVecArr(overSample_In) << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): (*P_I_A2_Mask)(m, I_NCols_Im-1) = " << (*P_I_A2_Mask)(m, I_NCols_Im-1) << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): D_A2_Mask(m, I_NCols_Im-1) = " << D_A2_Mask(m, I_NCols_Im-1) << endl;
                #endif
                OArr((I_NCols_Im * overSample_In) + I_A1_IFirstPix(m), 0) = D_A2_Im(m, I_NCols_Im - 1) * OmegaVecArr(overSample_In) * D_A2_Mask(m, I_NCols_Im - 1);
                  ...
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): 5. OArr set to " << OArr << endl;//.transpose(blitz::secondDim,blitz::firstDim) << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): spectrum_Out(m) = " << spectrum_Out(m) << endl;
                #endif
                BLVecArr(blitz::Range::all()) += ((spectrum_Out(m) * OArr(blitz::Range::all(), 0)));
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": end for(m(=" << m << ")=0; m<NRows(=" << I_NRows_Im << "); m++): BLVecArr set to " << BLVecArr << endl;
                #endif
                #ifdef __DEBUG_SLITFUNC_X__
                  string fName(DEBUGDIR);
                  fName += "OArr_new" + debugFilesSuffix + "_row";
                  if (m < 100)
                    fName += "0";
                  if (m < 10)
                    fName += "0";
              ...
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": end for(m=0; m<NRows; m++): OArr set to " << OArr << endl;//.transpose(blitz::secondDim,blitz::firstDim) << endl;
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": end for(m=0; m<NRows; m++): BLVecArr set to " << BLVecArr << endl;
              #endif
              ...
              if (D_WingSmoothFactor > 0.){
                if (I_Iter_SF == 1){
                  ...
                  #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                    cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(WING_SMOOTH_FACTOR): 1. SFVecArrTemp set to " << SFVecArrTemp << endl;
                  #endif
                  ...
                  #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                    cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(WING_SMOOTH_FACTOR): 2. SFVecArrTemp set to " << SFVecArrTemp << endl;
                    cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(WING_SMOOTH_FACTOR): Lambda = " << Lambda << endl;
                  #endif
                  D_A1_Lamb_SF = Lambda * (1. + D_WingSmoothFactor / (SFVecArrTemp));
                }
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(WING_SMOOTH_FACTOR): D_A1_Lamb_SF set to " << D_A1_Lamb_SF << endl;
                #endif
                ...
                **/
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": Start 1st order Tikhonov: AKLArr = " << AKLArr << endl;//.transpose(blitz::secondDim,blitz::firstDim) << endl;
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": Start 1st order Tikhonov: D_A1_Lamb_SF = " << D_A1_Lamb_SF << endl;
              #endif

              AKLArr(0, overSample_In) += D_A1_Lamb_SF(0); /** + Lambda to the upper-left element **/
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": 1st order Tikhonov: AKLArr(0,overSample_In=" << overSample_In << ") set to " << AKLArr(0,overSample_In) << endl;
              #endif

              AKLArr(I_NPixSlitF-1,overSample_In) += D_A1_Lamb_SF(I_NPixSlitF - 1); /** and to the lower-right **/
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": 1st order Tikhonov: AKLArr(I_NPixSlitF-1=" << I_NPixSlitF-1 << ",overSample_In=" << overSample_In << ") set to " << AKLArr(I_NPixSlitF-1,overSample_In) << endl;
              #endif
              ...
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": 1st order Tikhonov: AKLArr(blitz::Range(1,I_NPixSlitF-2=" << I_NPixSlitF-2 << "),overSample_In=" << overSample_In << ") set to " << AKLArr(blitz::Range(1,I_NPixSlitF-2),overSample_In) << endl;
              #endif
              ...
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": 1st order Tikhonov: AKLArr(blitz::Range(0,I_NPixSlitF-2=" << I_NPixSlitF-2 << "),overSample_In+1=" << overSample_In+1 << ") set to " << AKLArr(blitz::Range(0,I_NCols_Im-2),overSample_In+1) << endl;
              #endif
              ...
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": 1st order Tikhonov: AKLArr(blitz::Range(1,I_NPixSlitF-1=" << I_NPixSlitF-1 << "),overSample_In-1=" << overSample_In-1 << ") set to " << AKLArr(blitz::Range(1,I_NPixSlitF-1),overSample_In-1) << endl;
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": Start. 1st order Tikhonov: AKLArr = " << AKLArr << endl;
              #endif
              ...
              **/
              ...
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": Start. 2nd order Tikhonov: AKLArr = " << AKLArr << endl;
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": Start. 2nd order Tikhonov: D_A2_AKLT = " << D_A2_AKLT << endl;
              #endif
              PP_Void[0] = D_A2_AKLT.data();
              PP_Void[1] = BLVecArr.data();
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": Start. 2nd order Tikhonov: BLVecArr = " << BLVecArr << endl;
              #endif
              PP_Void[2] = &I_NPixSlitF;
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": Start. 2nd order Tikhonov: I_NPixSlitF = " << I_NPixSlitF << endl;
              #endif
              TempInt = (2 * overSample_In) + 1;
              PP_Void[3] = &TempInt;
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": 2nd order Tikhonov: TempInt = " << TempInt << endl;
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": 2nd order Tikhonov: Starting BandSol(D_A2_AKLT=" << D_A2_AKLT << ", BLVecArr=" << BLVecArr << ", I_NPixSlitF=" << I_NPixSlitF << ", TempInt=" << TempInt << ")" << endl;
              #endif
              ::pfs::drp::stella::math::BandSol(4, PP_Void);
              free(PP_Void);
              AKLArr = D_A2_AKLT.transpose(blitz::secondDim, blitz::firstDim);
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": 2nd order Tikhonov: After BandSol: D_A2_AKLT=" << D_A2_AKLT << ", AKLArr=" << AKLArr << ", BLVecArr=" << BLVecArr << ", I_NPixSlitF=" << I_NPixSlitF << ", TempInt=" << TempInt << endl;
              #endif
              SFVecArr.resize(BLVecArr.size());
              if (abs(blitz::sum(BLVecArr)) < 0.000000001)
              {
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": WARNING: blitz::sum(BLVecArr) == 0 => Setting to 1." << endl;
                BLVecArr = 1.;
              }
              double D_SumBLVecArr = blitz::sum(BLVecArr);
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": blitz::sum(BLVecArr) = " << D_SumBLVecArr << endl;
              #endif
              if (D_SumBLVecArr == 0.){
                string message("FiberTrace");
                message += to_string(fiberTraceNumber);
              ...
              SFVecArr = SFVecArr / D_SumBLVecArr * overSample_In;
                ...
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": Writing File " << SFVecArr << endl;
                ::pfs::drp::stella::utils::WriteArrayToFile(SFVecArr, sOArr, string("ascii"));

                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": 4.     2nd order Tikhonov: SFVecArr ( = BLVecArr / blitz::sum(BLVecArr)(=" << blitz::sum(BLVecArr) << ") * overSample_In(=" << overSample_In << ")) = " << SFVecArr << endl;
              #endif

              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": 2nd order Tikhonov: spectrum_Out = " << spectrum_Out << endl;
              #endif
              SPOldVecArr.resize(spectrum_Out.size());
              SPOldVecArr = spectrum_Out;
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": 2nd order Tikhonov: SPOldVecArr = " << SPOldVecArr << endl;
              #endif
              ...
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": 2nd order Tikhonov: RVecArr = " << RVecArr << endl;
              #endif

              OmegaVecArr.resize(overSample_In);
              OmegaVecArr = Weight;
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": 2nd order Tikhonov: OmegaVecArr = " << OmegaVecArr << endl;
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: Before TempDVecArrA: *P_I_A2_MaskIn = " << *P_I_A2_MaskIn << endl;
              #endif
              ...
              for (int m = 0; m < I_NRows_Im; m++)
              {
                ...
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m==" << m << "): OmegaVecArr(0) set to " << OmegaVecArr(0) << endl;
                #endif
                ...
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m==" << m << "): 1. TempDVecArr set to " << TempDVecArr << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": Starting Reform: I_NCols_Im = " << I_NCols_Im << ", overSample_In = " << overSample_In << endl;
                #endif
                blitz::Array<double, 2> *p_SSFTArr = ::pfs::drp::stella::math::Reform(TempDVecArr, (int)I_NCols_Im, overSample_In);
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": fiberTraceNumber = " << fiberTraceNumber << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": Reform finished: p_SSFTArr set to " << *p_SSFTArr << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_NCols_Im = " << I_NCols_Im << endl;
                #endif
                SSFArr.resize(overSample_In, (int)I_NCols_Im);
                SSFArr = p_SSFTArr->transpose(blitz::secondDim, blitz::firstDim);
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": SSFArr set to " << SSFArr << endl;
                #endif
                delete p_SSFTArr;
                TempDVecArr.resize(0);
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m==" << m << "): SSFArr set to " << SSFArr << endl;//.transpose(blitz::secondDim, blitz::firstDim) << endl;
                #endif
                ...
                blitz::Array<double, 1> *p_TempDVecArrBB = ::pfs::drp::stella::math::MatrixTimesVecArr(D_A2_TempAA,
                                                                                                OmegaVecArr);
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m==" << m << "): 2. TempDVecArr set to " << *p_TempDVecArrBB << endl;
                #endif
                OArr.resize(tempint, 1);
                OArr(blitz::Range(0,tempint-1), 0) = (*p_TempDVecArrBB)(blitz::Range(0,tempint-1));
                delete p_TempDVecArrBB;
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m==" << m << "): OArr(blitz::Range(0,tempint-1), 0) set to " << OArr(blitz::Range(0,tempint-1), 0) << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m==" << m << "): D_A2_Im.cols(=" << I_NCols_Im << ") - D_A2_XX(" << m << ",I_A1_ILastSpec(m)=" << I_A1_ILastSpec(m) << ")(=" << D_A2_XX(m,I_A1_ILastSpec(m)) << ") = " << I_NCols_Im - D_A2_XX(m,I_A1_ILastSpec(m)) << endl;
                #endif
                XXX = I_NCols_Im - D_A2_XX(m,I_A1_ILastSpec(m));
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m==" << m << "): XXX set to " << XXX << endl;
                #endif
                ...
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m==" << m << "): OArr(I_NCols_Im - 1, 0) set to " << OArr(I_NCols_Im - 1, 0) << endl;//.transpose(blitz::secondDim, blitz::firstDim) << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m==" << m << "): D_A2_Im(m, all()) = " << D_A2_Im(m, blitz::Range::all()) << endl;
                #endif
                ...
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_A1_TempDVecArr: D_A2_Im(m=" << m << ", blitz::Range::all()) = " << D_A2_Im(m, blitz::Range::all()) << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_A1_TempDVecArr: P_I_A2_Mask(m=" << m << ", blitz::Range::all()) = " << (*P_I_A2_Mask)(m, blitz::Range::all()) << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_A1_TempDVecArr: D_A2_Mask(m=" << m << ", blitz::Range::all()) = " << D_A2_Mask(m, blitz::Range::all()) << endl;
                #endif
                ...
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_A1_TempDVecArr = " << D_A1_TempDVecArr << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_A1_TempDVecArrAA = " << D_A1_TempDVecArrAA << endl;
                #endif
                #ifdef __DEBUG_CHECK_INDICES__
                ...
                #ifdef __DEBUG_SLITFUNC__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m==" << m << "): RVecArr(m) set to " << RVecArr(m) << endl;
                #endif
                ...
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m==" << m << "): spectrum_Out(m=" << m << ") set to " << spectrum_Out(m) << endl;
                #endif
                if (fabs(spectrum_Out(m)) < 0.000001)
                {
                  spectrum_Out(m) = blitz::sum(blitz::pow2(OArr));
                  #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                    cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": for(m==" << m << "): was == 0: spectrum_Out(m=" << m << ") set to " << spectrum_Out << endl;
                  #endif
                }
                ...
                if (I_Iter_SF > 1)
                {
                  ...
                  #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                    cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": for(m==" << m << "): I_Iter_SF(=" << I_Iter_SF << ") > 1: TempDVecArr set to " << TempDVecArr << endl;
                  #endif

                  TempDVecArrB = OArr(blitz::Range::all(), 0);
                  #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                    cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": for(m==" << m << "): I_Iter_SF(=" << I_Iter_SF << ") > 1: TempDVecArrB set to " << TempDVecArrB << endl;
                  #endif
                  ...
                  ::pfs::drp::stella::math::Double((*P_I_A2_Mask), D_A2_Mask);
                    ...
                    if (P_I_A2_Mask->rows() != D_A2_Mask.rows()){
                      string message("FiberTrace");
                      message += to_string(fiberTraceNumber) + "::SlitFunc: ERROR: 3. P_I_A2_Mask->rows() != D_A2_Mask.rows()";
                      cout << message << endl;
                      throw LSST_EXCEPT(pexExcept::Exception, message.c_str());    
                    }
                  #endif
                  if (fabs(mean(*P_I_A2_Mask) - mean(D_A2_Mask)) > 0.0000001){
                    string message("FiberTrace");
                    message += to_string(fiberTraceNumber) + "::SlitFunc: ERROR: 3. mean(P_I_A2_Mask)(=" + to_string(mean(*P_I_A2_Mask)) + ") != mean(D_A2_Mask)(=";
              ...
              #endif
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: After TempDVecArrA: *P_I_A2_Mask = " << *P_I_A2_Mask << endl;
                cout << "blitz::sum(*P_I_A2_MaskIn) = " << blitz::sum(*P_I_A2_MaskIn) << endl;
                cout << "blitz::sum(*P_I_A2_Mask) = " << blitz::sum(*P_I_A2_Mask) << endl;
              #endif
              ...
              if (abs(Lamb_SP) > 0.0000001)
              {
                ...
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": KeyWord_Set(LAMBDA_SP): Lambda set to " << Lambda << endl;
                #endif
                a.resize(I_NRows_Im);
                a = 0. - Lambda;
                a(0) = 0.;
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": KeyWord_Set(LAMBDA_SP): a set to " << a << endl;
                #endif
                b.resize(I_NRows_Im);
                b = (2. * Lambda) + 1.;
                b(0) = Lambda + 1.;
                ...
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": KeyWord_Set(LAMBDA_SP): b set to " << b << endl;
                #endif
                c.resize(I_NRows_Im);
                c = 0. - Lambda;
                c(I_NRows_Im - 1) = 0.;
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": KeyWord_Set(LAMBDA_SP): c set to " << c << endl;
                #endif
                ...
                #endif
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: Before TriDag: RVecArr = " << RVecArr << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: Before TriDag: spectrum_Out = " << spectrum_Out << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: Before TriDag: a = " << a << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: Before TriDag: b = " << b << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: Before TriDag: c = " << c << endl;
                #endif
                TempDVecArr.resize(I_NRows_Im);
                TempDVecArr = RVecArr / spectrum_Out;
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: Before TriDag: TempDVecArr = " << TempDVecArr << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": KeyWord_Set(LAMBDA_SP): TempDVecArr set to " << TempDVecArr << endl;
                #endif
                ::pfs::drp::stella::math::TriDag(a, b, c, TempDVecArr, spectrum_Out);
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": KeyWord_Set(LAMBDA_SP): after TriDag: spectrum_Out set to " << spectrum_Out << endl;
                #endif
                ...
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": Not KeyWord_Set(LAMBDA_SP): spectrum_Out set to " << spectrum_Out << endl;
                #endif
              ...
              #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": end if (max(fabs(spectrum_Out - SPOldVecArr) / max(spectrum_Out)=" << max(spectrum_Out) << ")=" << max(fabs(spectrum_Out - SPOldVecArr) / max(spectrum_Out)) << " > 0.00001)" << endl;
              #endif
            ...
            else
            {
              ...
              {
                #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_SF = " << I_Iter_SF << ": !if (max(fabs(spectrum_Out - SPOldVecArr) / max(spectrum_Out)=" << max(spectrum_Out) << ")=" << max(fabs(spectrum_Out - SPOldVecArr) / max(spectrum_Out)) << " > 0.00001) => breaking while loop" << endl;
                #endif
                break;
              }/// end if (I_Iter_SF != 1)
          ...
          #ifdef __DEBUG_SLITFUNC_PISKUNOV__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): I_NRows_Im set to " << I_NRows_Im << endl;
          #endif
          if ((Pos = ::pfs::drp::stella::utils::KeyWord_Set(S_A1_Args_In, "USE_ROW")) >= 0)// && TempIntB != 0)
          {
            ...
            D_A1_Ind = i;
            #ifdef __DEBUG_SLITFUNC_PISKUNOV__
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): KeyWord_Set(USE_ROW): MARK: INTERPOL: spectrum_Out = " << spectrum_Out << endl;
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): KeyWord_Set(USE_ROW): MARK: INTERPOL: D_A1_Ind = " << D_A1_Ind << endl;
            #endif
            blitz::Array<double, 1> tempDblVecArrA = ::pfs::drp::stella::math::Double(UseRowVecArr);
            #ifdef __DEBUG_SLITFUNC_PISKUNOV__
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": tempDblVecArrA = " << tempDblVecArrA << endl;
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": D_A1_Ind = " << D_A1_Ind << endl;
            #endif
            ...
            #ifdef __DEBUG_SLITFUNC_PISKUNOV__
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): KeyWord_Set(USE_ROW): MARK: INTERPOL: spectrum_Out set to " << spectrum_Out << endl;
            #endif
          }///end if KeyWord_Set(USE_ROW)
          OmegaVecArr.resize(overSample_In);
          OmegaVecArr = Weight;
          #ifdef __DEBUG_SLITFUNC_PISKUNOV__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): OmegaVecArr set to " << OmegaVecArr << endl;
          #endif

          D_A1_SFO.resize(SFVecArr.size());
          D_A1_SFO = SFVecArr;
          #ifdef __DEBUG_SLITFUNC_PISKUNOV__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: SFVecArr = " << SFVecArr << endl;
          #endif
          D_A1_SFO = blitz::where(D_A1_SFO < 0., 0., D_A1_SFO);
          D_A1_SFO = blitz::where(D_A1_SFO > (I_NCols_Im+1), 0., D_A1_SFO);
          if (I_Telluric == 3){
          ...
          for (int m = 0; m < I_NRows_Im; m++)  /// Evaluate the new spectrum
          {
            OmegaVecArr(0) = D_A2_XX(m,I_A1_IFirstSpec(m));
            #ifdef __DEBUG_SLITFUNC_PISKUNOV__
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): OmegaVecArr(0) set to " << OmegaVecArr(0) << endl;
            #endif

            SSFArr.resize(overSample_In, I_NCols_Im);
            SSFArr = 0.;
            #ifdef __DEBUG_SLITFUNC_PISKUNOV__
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): SFVecArr = " << SFVecArr << endl;
            #endif
            TempDVecArr.resize(I_A1_ILastSpec(m) - I_A1_IFirstSpec(m) + 1);
            TempDVecArr = SFVecArr(blitz::Range(I_A1_IFirstSpec(m), I_A1_ILastSpec(m)));
            #ifdef __DEBUG_SLITFUNC_PISKUNOV__
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): TempDVecArr set to " << TempDVecArr << endl;
            #endif
            #ifdef __DEBUG_CHECK_INDICES__
            ...
            delete p_D_A2_SSFT;
            #ifdef __DEBUG_SLITFUNC_PISKUNOV__
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): SSFArr set to " << SSFArr << endl;//.transpose(blitz::secondDim, blitz::firstDim) << endl;
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): OmegaVecArr set to " << OmegaVecArr << endl;
            #endif
            ...
            #ifdef __DEBUG_SLITFUNC_PISKUNOV__
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): OArr set to " << OArr << endl;//.transpose(blitz::secondDim, blitz::firstDim) << endl;
            #endif

            XXX = I_NCols_Im - D_A2_XX(m,I_A1_ILastSpec(m));
            #ifdef __DEBUG_SLITFUNC_PISKUNOV__
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): XXX set to " << XXX << endl;
            #endif
            ...
            IVecArr.resize(I_NCols_Im);
              ...
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: (*P_D_A1_SPErrOut)(m) set to " << (*P_D_A1_SPErrOut)(m) << endl;
            ...
            D_A2_Mask(m, blitz::Range::all()) = D_A1_Mask;
              ...
              if (P_I_A2_Mask->rows() != D_A2_Mask.rows()){
                string message("FiberTrace");
                message += to_string(fiberTraceNumber) + "::SlitFunc: ERROR: 5. P_I_A2_Mask->rows() != D_A2_Mask.rows()";
                cout << message << endl;
                throw LSST_EXCEPT(pexExcept::Exception, message.c_str());    
              }
            #endif
            ...
            #ifdef __DEBUG_SLITFUNC_PISKUNOV__
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": blitz::sum(*P_I_A2_MaskIn) = " << blitz::sum(*P_I_A2_MaskIn) << endl;
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": blitz::sum(*P_I_A2_Mask) = " << blitz::sum(*P_I_A2_Mask) << endl;
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): P_I_A2_Mask->size() = " << P_I_A2_Mask->size() << endl;
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): IVecArr.size() = " << IVecArr.size() << endl;
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): NInd set to " << NInd << endl;
            #endif
            #ifdef __DEBUG_CHECK_INDICES__
            ...
            if ((Pos = ::pfs::drp::stella::utils::KeyWord_Set(S_A1_Args_In, "BAD")) >= 0)
            {
              ...
              for (int n = 0; n < P_I_A2_Mask->cols(); n++)
              {
                if ((*P_I_A2_Mask)(m,n) > 0)
                {
                  ...
                  #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                    cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): for(n(==" << n << ")=0; n< P_I_A2_Mask->cols(=" << P_I_A2_Mask->cols() << "; n++): IFirstVecArr(TempInt=" << TempInt << ") set to " << IFirstVecArr(TempInt) << endl;
                  #endif
                  TempInt++;
                }
                else
                {
                  ...
                  #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                    cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): for(n(==" << n << ")=0; n< P_I_A2_Mask->cols(=" << P_I_A2_Mask->cols() << "; n++): TempIVecArr(TempIntA=" << TempIntA << ") set to " << TempIVecArr(TempIntA) << endl;
                  #endif
                ...
                if (NInd < I_NCols_Im)  /// Bad pixels in column m
                {
                  ...
                  #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                    cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): NInd(=" << NInd << ") < D_A2_Im.cols(=" << I_NCols_Im << "): TempLong set to " << TempLong << endl;
                  #endif
                  ...
                  #ifdef __DEBUG_SLITFUNC_PISKUNOV__
                    cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): NInd(=" << NInd << ") < D_A2_Im.cols(=" << I_NCols_Im << "): P_I_A1_JBadVecArr set to " << (*P_I_A1_JBadVecArr) << ")" << endl;
                  #endif
            ...
            #ifdef __DEBUG_SLITFUNC_PISKUNOV__
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): 2. spectrum_Out = " << spectrum_Out << endl;
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): spectrum_Out(m) = " << spectrum_Out(m) << endl;
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(PROF_OUT): for(m(==" << m << ")=0; m< I_NRows_Im(=" << I_NRows_Im << "; m++): OArr = " << OArr << endl;//.transpose(blitz::secondDim, blitz::firstDim) << endl;
            #endif
            #ifdef __DEBUG_CHECK_INDICES__
            ...
            #endif
            #ifdef __DEBUG_SLITFUNC_PISKUNOV__
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": m=" << m << ": P_D_A2_Prof_Out->size() = " << P_D_A2_Prof_Out->size() << endl;
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": m=" << m << ": P_D_A2_Prof_Out->rows() = " << P_D_A2_Prof_Out->rows() << endl;
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": m=" << m << ": P_D_A2_Prof_Out->cols() = " << P_D_A2_Prof_Out->cols() << endl;
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": m=" << m << ": OArr.size() = " << OArr.size() << endl;
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": m=" << m << ": OArr.rows() = " << OArr.rows() << endl;
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": m=" << m << ": OArr.cols() = " << OArr.cols() << endl;
            #endif
          } /// end for (int m = 0; m < I_NRows_Im; m++)
        //}/// end if (!doSplineFit)
        for (int m = 0; m < I_NRows_Im; m++){
          ...
          double D_Offset = -1./static_cast<double>(fiberTraceProfileFittingControl->overSample);
          if (I_XCorProf == 0)
            D_Offset = 0.;
          double D_MinOffset = 0.;
          D_A1_XX = D_A2_XX(m, blitz::Range::all());
          D_A1_SFO = D_A1_SFO * fiberTraceProfileFittingControl->overSample / sum(D_A1_SFO);
          #ifdef __DEBUG_SLITFUNC_X__
          ...
          for (int i_cross=0; i_cross < I_XCorProf; i_cross++){
            ...
            if (!::pfs::drp::stella::math::InterPol(D_A1_SFO, D_A1_XX, D_A1_XProf, D_A1_YProf)){
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: ERROR: InterPol(D_A2_SFO=" << D_A1_SFO << ", D_A1_XX=" << D_A1_XX << ", D_A1_XProf=" << D_A1_XProf << ", D_A1_YProf) returned FALSE" << endl;
              string message("FiberTrace");
              message += to_string(fiberTraceNumber) + "::SlitFunc: ERROR: InterPol(D_A1_SFO, D_A1_XX, D_A1_XProf, D_A1_YProf) returned FALSE";
              cout << message << endl;
              throw LSST_EXCEPT(pexExcept::Exception, message.c_str());    
            }
            #ifdef __DEBUG_SLITFUNC__
            ...
            #ifdef __DEBUG_SLITFUNC_N__
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiber " << fiberTraceNumber << ": bin = " << I_Bin << ": row " << m << ": i_cross=" << i_cross << ": offset=" << D_Offset << ": minError=" << D_MinError << ": error=" << D_Error << ": D_MinOffset=" << D_MinOffset << endl;
            #endif
            D_Offset += .2 / I_XCorProf;
          }
          (*P_D_A1_XCorProfOut)(m) = D_MinOffset;
          if (I_XCorProf > 0)
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiber " << fiberTraceNumber << ": bin " << I_Bin << ": row=" << m << ": D_MinOffset=" << D_MinOffset << endl;
        ...
        if (I_XCorProf > 0){
          ...
          blitz::Array<double, 1> D_A1_PolyCoeffs = ::pfs::drp::stella::math::PolyFit(D_A1_XPF,
                                                                                      *P_D_A1_XCorProfOut,
                                                                                      I_NDeg,
                                                                                      S_A1_Args_PolyFit,
                                                                                      PP_Args_PolyFit);
            ...
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: after PolyFit: P_D_A1_XCorProfOut = " << *P_D_A1_XCorProfOut << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: after PolyFit: D_A1_Fit = " << D_A1_Fit << endl;
            ...
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: after PolyFit: D_A1_Diff = " << D_A1_Diff << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: after PolyFit: max(D_A1_Diff) = " << max(D_A1_Diff) << endl;
          #endif
          free(PP_Args_PolyFit);
          (*P_D_A1_XCorProfOut) = D_A1_Fit;
        }
  //      #ifdef __DEBUG_SLITFUNC_X__
  //        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_A2_XX = " << D_A2_XX << endl;
  //        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_A1_Fit = " << D_A1_Fit << endl;
  //      #endif
        for (int m=0; m < I_NRows_Im; m++){
          //D_A1_XX(D_A2_XX.cols());
          D_A1_XX = D_A2_XX(m, blitz::Range::all()) + D_A1_Fit(m);
          #ifdef __DEBUG_SLITFUNC_X__
            //cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_A2_XX(" << m << ", *) = " << D_A2_XX(m, blitz::Range::all()) << endl;
            //cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_A1_Fit(" << m << ") = " << D_A1_Fit(m) << endl;
            //cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": D_A1_XX = " << D_A1_XX << endl;
            //cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": D_A1_SFO = " << D_A1_SFO << endl;
  //          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": D_A1_Range = " << D_A1_Range << endl;
          ...
          #endif
          if (!::pfs::drp::stella::math::InterPol(D_A1_SFO, D_A1_XX, D_A1_XProf, D_A1_YProf)){
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: ERROR: InterPol(D_A1_SFO=" << D_A1_SFO << ", D_A1_XX=" << D_A1_XX << ", D_A1_XProf=" << D_A1_XProf << ", D_A1_YProf) returned FALSE" << endl;
            string message("FiberTrace");
            message += to_string(fiberTraceNumber) + "::SlitFunc: ERROR: InterPol(D_A1_SFO, D_A1_XX, D_A1_XProf, D_A1_YProf) returned FALSE";
            cout << message << endl;
            throw LSST_EXCEPT(pexExcept::Exception, message.c_str());    
          ...
          if (I_Telluric == 3){
            ...
            if (fabs(D_SumSF) > 0.00000000000000001){
              ...
              string message("FiberTrace");
              message += to_string(fiberTraceNumber) + "::SlitFunc: ERROR: m = " + to_string(m) + ": D_SumSF = 0.";
              cout << message << endl;
              throw LSST_EXCEPT(pexExcept::Exception, message.c_str());    
            }
          }

          if (fabs(sum(profile_Out(m, blitz::Range::all()))) < 0.000000001){
            string message("FiberTrace");
            message += to_string(fiberTraceNumber) + "::SlitFunc: ERROR: profile_Out(m=" + to_string(m) + ", *) = 0";
            cout << message << endl;
            throw LSST_EXCEPT(pexExcept::Exception, message.c_str());    
          }
          ...
          if ((Pos = ::pfs::drp::stella::utils::KeyWord_Set(S_A1_Args_In, "IM_OUT")) >= 0)
          {
            ...
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fname_prof=<" << fname_prof << "> written" << endl;
          #endif
        }/// end for (int m=0; m < I_NRows_Im; m++){
        #ifdef __DEBUG_SLITFUNC_X__
        ...
        if (I_Telluric == 2)
        {
          ...
          #ifdef __DEBUG_TELLURIC__
            cout << endl << "FiberTrace" << fiberTraceNumber << "::SlitFunc: before Fit: D_A2_MySF = " << D_A2_MySF << endl << endl;
          #endif
          ...
          for (xxx = 0; xxx < P_I_A2_Mask->rows(); xxx++){
            for (yyy = 0; yyy < P_I_A2_Mask->cols(); yyy++){
              ...
              #ifdef __DEBUG_TELLURIC__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": xxx = " << xxx << ", yyy = " << yyy << ": I_RangeMinRow = " << I_RangeMinRow << ", I_RangeMaxRow = " << I_RangeMaxRow << endl;
              #endif
              ...
              #ifdef __DEBUG_TELLURIC__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": xxx = " << xxx << ", yyy = " << yyy << " I_RangeMinCol = " << I_RangeMinCol << ", I_RangeMaxCol = " << I_RangeMaxCol << endl;
              #endif

              i_nrows = (I_RangeMaxRow - I_RangeMinRow + 1);
              i_ncols = (I_RangeMaxCol - I_RangeMinCol + 1);
              #ifdef __DEBUG_TELLURIC__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": i_nrows = " << i_nrows << ", i_ncols = " << i_ncols << endl;
              #endif
              ...
              #ifdef __DEBUG_TELLURIC__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_A3_IndicesRange(Subarr) set to " << I_A3_IndicesRange << endl;
              #endif
              ...
              #ifdef __DEBUG_TELLURIC__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_A2_TempArr(Subarr) set to " << I_A2_TempArr << endl;
              #endif
                ...
                (blitz::sum((*P_I_A2_Mask)(xxx,blitz::Range::all())) == 0))
              {
                ...
                #ifdef __DEBUG_TELLURIC__
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": (*P_I_A2_Mask)(xxx,yyy) = " << (*P_I_A2_Mask)(xxx,yyy) << " == 1 ||" << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": blitz::sum(I_A2_TempArr) = " << blitz::sum(I_A2_TempArr) << " < I_A2_TempArr.size() / 1.5 = " << I_A2_TempArr.size() / 1.5 << " ||" << endl;
                  cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": blitz::sum((*P_I_A2_Mask)(xxx,blitz::Range::all())) = " << blitz::sum((*P_I_A2_Mask)(xxx,blitz::Range::all())) << " == 0" << endl;
                #endif
              }
              else{
              ...
              #ifdef __DEBUG_TELLURIC__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": D_A2_ImTimesMask(xxx=" << xxx << ",yyy=" << yyy << ") set to " << D_A2_ImTimesMask(xxx, yyy) << endl;
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": D_A2_SFTimesMask(xxx=" << xxx << ",yyy=" << yyy << ") set to " << D_A2_SFTimesMask(xxx, yyy) << endl;
              #endif
            }
          }
          ...
          D_A1_Sky = 1.;
          #ifdef __DEBUG_TELLURIC__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": D_A2_ImTimesMask = " << D_A2_ImTimesMask << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": *P_D_A2_Prof_Out = " << *P_D_A2_Prof_Out << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": D_A2_SFTimesMask = " << D_A2_SFTimesMask << endl;
            ...
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": File " << S_MySF << " written" << endl;
                                                  ...
                                                  PP_Args_Fit))
          {
            ...
            ::pfs::drp::stella::utils::WriteFits(&D_A2_SFTimesMask, S_MySF);
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": File " << S_MySF << " written" << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": 3. spectrum_Out = " << spectrum_Out << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": Fit returned TRUE" << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": after Fit: D_A1_MySP = " << D_A1_MySP << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": after Fit: D_A1_Sky = " << D_A1_Sky << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": after Fit: D_A1_ChiSquare_LinFit = " << D_A1_ChiSquare_LinFit << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": after Fit: D_A1_Probability_LinFit = " << D_A1_Probability_LinFit << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": after Fit: D_A2_Sigma_LinFit = " << D_A2_Sigma_LinFit << endl;
          #endif
          if (I_Stop > 0)
            return false;

          #ifdef __DEBUG_TELLURIC__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": __TELLURIC_MINE__: spectrum_Out = " << spectrum_Out << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": __TELLURIC_MINE__: D_A1_MySP set to " << D_A1_MySP << endl;
          #endif
          ...
          if (Pos >= 0)
          {
            ...
            {
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": KeyWord_Set(STOP) == 1" << endl;
              if (I_Iter_SF == 1){
                string message("FiberTrace");
                message += to_string(fiberTraceNumber) + "::SlitFunc: fiberTraceNumber = " + to_string(fiberTraceNumber) + ": I_Bin = " + to_string(I_Bin);
        ...
        #ifdef __DEBUG_SLITFUNC__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": I_Iter_Sky = " << I_Iter_Sky << ": D_A1_OldSky - D_A1_Sky = " << D_A1_OldSky << endl;
        #endif
        if (mean(D_A1_OldSky) < 0.005)
          break;
        D_A1_OldSky = D_A1_Sky;
      } while(I_Iter_Sky < static_cast<int>(fiberTraceProfileFittingControl->maxIterSky));
      ...
      int I_SubPix = 0;
      #ifdef __DEBUG_SLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_A2_Im.rows() = " << D_A2_Im.rows() << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_A2_Im.cols() = " << D_A2_Im.cols() << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: SFVecArr = " << SFVecArr << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_A2_Weights(0:3, *) = " << D_A2_Weights(blitz::Range(0,3), blitz::Range::all()) << endl;
      #endif
      ...
      for (int i_row=0; i_row<D_A2_Im.rows(); i_row++){
        ...
        for (int i_col=0; i_col<D_A2_Im.cols(); i_col++){
          ...
          for (int i_j=0; i_j<static_cast<int>(SFVecArr.size())-1; i_j++){
            #ifdef __DEBUG_SLITFUNC__
              cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: i_row = " << i_row << ": i_col = " << i_col << ": I_SubPix = " << I_SubPix << ": i_j = " << i_j << ": D_A2_XX(i_row, i_j) = " << D_A2_XX(i_row, i_j) << ": int(D_A2_XX(i_row, i_j)) = " << int(D_A2_XX(i_row, i_j)) << endl;
            #endif
            if ((int(D_A2_XX(i_row, i_j)) == i_col) || ((int(D_A2_XX(i_row, i_j)) <= i_col) && (D_A2_XX(i_row, i_j+1) > i_col))){
              #ifdef __DEBUG_TELLURIC__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: SubPixel found" << endl;
              #endif
              D_Sum_ProfTimesWeight += SFVecArr(i_j) * D_A2_Weights(i_row, I_SubPix);
              #ifdef __DEBUG_TELLURIC__
                cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: i_row = " << i_row << ": i_col = " << i_col << ": I_SubPix = " << I_SubPix << ": i_j = " << i_j << ": SFVecArr(i_j) = " << SFVecArr(i_j) << ": D_A2_Weights(i_row, I_SubPix) = " << D_A2_Weights(i_row, I_SubPix) << ": D_Sum_ProfTimesWeight = " << D_Sum_ProfTimesWeight << endl;
              #endif
              I_SubPix++;
          ...
          #ifdef __DEBUG_SLITFUNC__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: i_row = " << i_row << ": i_col = " << i_col << ": sumProfTimesWeightRow = " << sumProfTimesWeightRow << endl;
          #endif
          ...
          #ifdef __DEBUG_TELLURIC__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: i_row = " << i_row << ": i_col = " << i_col << ": D_A1_CY_SP(i_row) = " << D_A1_CY_SP(i_row) << endl;
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: i_row = " << i_row << ": i_col = " << i_col << ": D_A1_DY(i_row) = " << D_A1_DY(i_row) << endl;
          #endif
          ...
          #ifdef __DEBUG_TELLURIC__
            cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: (*P_D_A1_SPErrOut)(i_row = " << i_row << ") = " << (*P_D_A1_SPErrOut)(i_row) << endl;
          #endif
        #endif

        (*P_D_A1_SPOut)(i_row) = (D_A1_CY_SP(i_row) / D_A1_DY(i_row)) / overSample_In;
        #ifdef __DEBUG_TELLURIC__
          cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: (*P_D_A1_SPOut)(i_row = " << i_row << ") = " << (*P_D_A1_SPOut)(i_row) << endl;
        #endif
      }/// end for (int i_row=0; i_row<D_A2_Im.rows(); i_row++)
      #ifdef __DEBUG_SLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_A1_CY_SP = " << D_A1_CY_SP << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: D_A1_DY = " << D_A1_DY << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: spectrum_Out = " << spectrum_Out << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: P_D_A1_SPOut = " << *P_D_A1_SPOut << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: P_D_A1_SPErrOut = " << *P_D_A1_SPErrOut << endl;
      #endif
      blitz::Array<double, 1> D_A1_SNR(spectrum_Out.size());
      D_A1_SNR = spectrum_Out / (*P_D_A1_SPErrOut);
      #ifdef __DEBUG_SLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: SNR(spectrum_Out / P_D_A1_SPErrOut) = " << D_A1_SNR << endl;
      #endif
      D_A1_SNR = (*P_D_A1_SPOut) / (*P_D_A1_SPErrOut);
      #ifdef __DEBUG_SLITFUNC__
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: SNR(P_D_A1_SPOut / P_D_A1_SPErrOut) = " << D_A1_SNR << endl;
      #endif
      if (I_Telluric == 2)
      {
      ...
      spectrum_Out = blitz::where(spectrum_Out < 0., 0., spectrum_Out);
        ...
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": READY: P_I_A1_JBadVecArr set to " << (*P_I_A1_JBadVecArr) << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": READY: SFVecArr set to " << SFVecArr << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": READY: spectrum_Out set to " << spectrum_Out << endl;
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: fiberTraceNumber = " << fiberTraceNumber << ": I_Bin = " << I_Bin << ": READY: P_D_A2_Prof_Out set to " << *P_D_A2_Prof_Out << endl;//->transpose(blitz::secondDim, blitz::firstDim) << endl;
      #endif
      ...
      if ((Pos = ::pfs::drp::stella::utils::KeyWord_Set(S_A1_Args_In, "IM_OUT")) < 0)
      {
        ...
        if (!::pfs::drp::stella::utils::WriteFits(P_I_A2_Mask, S_MaskOut)){
          string message("FiberTrace");
          message += to_string(fiberTraceNumber) + "::SlitFunc: ERROR: WriteFits(Mask) returned FALSE";
          cout << message << endl;
          throw LSST_EXCEPT(pexExcept::Exception, message.c_str());    
        }
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: " << CS_MaskOut << " written" << endl;
      #endif
      if ((blitz::sum(*P_I_A2_Mask) > static_cast<int>(P_I_A2_Mask->size()) / 2) && (blitz::sum(*P_I_A2_Mask) == blitz::sum(*P_I_A2_MaskIn))){
        cout << "FiberTrace" << fiberTraceNumber << "::SlitFunc: WARNING: No cosmics detected" << endl;
      }
  ...
  //    ILastVecArr.resize(0);
    ...
    template blitz::Array<int, 1> Fix(const blitz::Array<int, 1> &);
    template blitz::Array<int, 1> Fix(const blitz::Array<long, 1> &);
    template blitz::Array<int, 1> Fix(const blitz::Array<float, 1> &);
    template blitz::Array<int, 1> Fix(const blitz::Array<double, 1> &);

    template blitz::Array<int, 2> Fix(const blitz::Array<unsigned short, 2> &);
    template blitz::Array<int, 2> Fix(const blitz::Array<unsigned int, 2> &);
    template blitz::Array<int, 2> Fix(const blitz::Array<int, 2> &);
    template blitz::Array<int, 2> Fix(const blitz::Array<long, 2> &);
    template blitz::Array<int, 2> Fix(const blitz::Array<float, 2> &);
    template blitz::Array<int, 2> Fix(const blitz::Array<double, 2> &);

    template blitz::Array<long, 1> FixL(const blitz::Array<unsigned short, 1> &);
    template blitz::Array<long, 1> FixL(const blitz::Array<unsigned int, 1> &);
    template blitz::Array<long, 1> FixL(const blitz::Array<int, 1> &);
    template blitz::Array<long, 1> FixL(const blitz::Array<long, 1> &);
    template blitz::Array<long, 1> FixL(const blitz::Array<float, 1> &);
    template blitz::Array<long, 1> FixL(const blitz::Array<double, 1> &);

    template blitz::Array<long, 2> FixL(const blitz::Array<unsigned short, 2> &);
    template blitz::Array<long, 2> FixL(const blitz::Array<unsigned int, 2> &);
    template blitz::Array<long, 2> FixL(const blitz::Array<int, 2> &);
    template blitz::Array<long, 2> FixL(const blitz::Array<long, 2> &);
    template blitz::Array<long, 2> FixL(const blitz::Array<float, 2> &);
    template blitz::Array<long, 2> FixL(const blitz::Array<double, 2> &);
  
    template blitz::Array<int, 1> Int(const blitz::Array<unsigned short, 1> &);
    template blitz::Array<int, 1> Int(const blitz::Array<unsigned int, 1> &);
    template blitz::Array<int, 1> Int(const blitz::Array<int, 1> &);
    template blitz::Array<int, 1> Int(const blitz::Array<long, 1> &);
    template blitz::Array<int, 1> Int(const blitz::Array<float, 1> &);
    template blitz::Array<int, 1> Int(const blitz::Array<double, 1> &);

    template blitz::Array<int, 2> Int(const blitz::Array<short unsigned int, 2> &);
    template blitz::Array<int, 2> Int(const blitz::Array<unsigned int, 2> &);
    template blitz::Array<int, 2> Int(const blitz::Array<int, 2> &);
    template blitz::Array<int, 2> Int(const blitz::Array<long, 2> &);
    template blitz::Array<int, 2> Int(const blitz::Array<float, 2> &);
    template blitz::Array<int, 2> Int(const blitz::Array<double, 2> &);

    template blitz::Array<long, 1> Long(const blitz::Array<unsigned short, 1> &);
    template blitz::Array<long, 1> Long(const blitz::Array<unsigned int, 1> &);
    template blitz::Array<long, 1> Long(const blitz::Array<int, 1> &);
    template blitz::Array<long, 1> Long(const blitz::Array<long, 1> &);
    template blitz::Array<long, 1> Long(const blitz::Array<float, 1> &);
    template blitz::Array<long, 1> Long(const blitz::Array<double, 1> &);

    template blitz::Array<long, 2> Long(const blitz::Array<unsigned short, 2> &);
    template blitz::Array<long, 2> Long(const blitz::Array<unsigned int, 2> &);
    template blitz::Array<long, 2> Long(const blitz::Array<int, 2> &);
    template blitz::Array<long, 2> Long(const blitz::Array<long, 2> &);
    template blitz::Array<long, 2> Long(const blitz::Array<float, 2> &);
    template blitz::Array<long, 2> Long(const blitz::Array<double, 2> &);

    template void Float(const blitz::Array<unsigned short, 1> &, blitz::Array<float, 1>&);
    template void Float(const blitz::Array<unsigned int, 1> &, blitz::Array<float, 1>&);
    template void Float(const blitz::Array<int, 1> &, blitz::Array<float, 1>&);
    template void Float(const blitz::Array<long, 1> &, blitz::Array<float, 1>&);
    template void Float(const blitz::Array<float, 1> &, blitz::Array<float, 1>&);
    template void Float(const blitz::Array<double, 1> &, blitz::Array<float, 1>&);

    template blitz::Array<float, 1> Float(const blitz::Array<unsigned short, 1> &);
    template blitz::Array<float, 1> Float(const blitz::Array<unsigned int, 1> &);
    template blitz::Array<float, 1> Float(const blitz::Array<int, 1> &);
    template blitz::Array<float, 1> Float(const blitz::Array<long, 1> &);
    template blitz::Array<float, 1> Float(const blitz::Array<float, 1> &);
    template blitz::Array<float, 1> Float(const blitz::Array<double, 1> &);

    template void Float(const blitz::Array<unsigned short, 2> &, blitz::Array<float, 2>&);
    template void Float(const blitz::Array<unsigned int, 2> &, blitz::Array<float, 2>&);
    template void Float(const blitz::Array<int, 2> &, blitz::Array<float, 2>&);
    template void Float(const blitz::Array<long, 2> &, blitz::Array<float, 2>&);
    template void Float(const blitz::Array<float, 2> &, blitz::Array<float, 2>&);
    template void Float(const blitz::Array<double, 2> &, blitz::Array<float, 2>&);

    template blitz::Array<float, 2> Float(const blitz::Array<unsigned short, 2> &);
    template blitz::Array<float, 2> Float(const blitz::Array<unsigned int, 2> &);
    template blitz::Array<float, 2> Float(const blitz::Array<int, 2> &);
    template blitz::Array<float, 2> Float(const blitz::Array<long, 2> &);
    template blitz::Array<float, 2> Float(const blitz::Array<float, 2> &);
    template blitz::Array<float, 2> Float(const blitz::Array<double, 2> &);

    template void Double(const blitz::Array<unsigned short, 1> &, blitz::Array<double, 1>&);
    template void Double(const blitz::Array<unsigned int, 1> &, blitz::Array<double, 1>&);
    template void Double(const blitz::Array<int, 1> &, blitz::Array<double, 1>&);
    template void Double(const blitz::Array<long, 1> &, blitz::Array<double, 1>&);
    template void Double(const blitz::Array<float, 1> &, blitz::Array<double, 1>&);
    template void Double(const blitz::Array<double, 1> &, blitz::Array<double, 1>&);

    template void Double(const blitz::Array<unsigned short, 2> &, blitz::Array<double, 2>&);
    template void Double(const blitz::Array<unsigned int, 2> &, blitz::Array<double, 2>&);
    template void Double(const blitz::Array<int, 2> &, blitz::Array<double, 2>&);
    template void Double(const blitz::Array<long, 2> &, blitz::Array<double, 2>&);
    template void Double(const blitz::Array<float, 2> &, blitz::Array<double, 2>&);
    template void Double(const blitz::Array<double, 2> &, blitz::Array<double, 2>&);

    template blitz::Array<double, 1> Double(const blitz::Array<unsigned short, 1> &Arr);
    template blitz::Array<double, 1> Double(const blitz::Array<unsigned int, 1> &Arr);
    template blitz::Array<double, 1> Double(const blitz::Array<int, 1> &Arr);
    template blitz::Array<double, 1> Double(const blitz::Array<long, 1> &Arr);
    template blitz::Array<double, 1> Double(const blitz::Array<float, 1> &Arr);
    template blitz::Array<double, 1> Double(const blitz::Array<double, 1> &Arr);

    template blitz::Array<double, 2> Double(const blitz::Array<unsigned short, 2> &Arr);
    template blitz::Array<double, 2> Double(const blitz::Array<unsigned int, 2> &Arr);
    template blitz::Array<double, 2> Double(const blitz::Array<int, 2> &Arr);
    template blitz::Array<double, 2> Double(const blitz::Array<long, 2> &Arr);
    template blitz::Array<double, 2> Double(const blitz::Array<float, 2> &Arr);
    template blitz::Array<double, 2> Double(const blitz::Array<double, 2> &Arr);

    template blitz::Array<unsigned short, 1> Replicate(unsigned short val, int Len);
    template blitz::Array<unsigned int, 1> Replicate(unsigned int val, int Len);
    template blitz::Array<int, 1> Replicate(int val, int Len);
    template blitz::Array<long, 1> Replicate(long val, int Len);
    template blitz::Array<float, 1> Replicate(float val, int Len);
    template blitz::Array<double, 1> Replicate(double val, int Len);

    template blitz::Array<unsigned short, 1>* Reform(const blitz::Array<unsigned short, 2> &Arr);
    template blitz::Array<unsigned int, 1>* Reform(const blitz::Array<unsigned int, 2> &Arr);
    template blitz::Array<int, 1>* Reform(const blitz::Array<int, 2> &Arr);
    template blitz::Array<long, 1>* Reform(const blitz::Array<long, 2> &Arr);
    template blitz::Array<float, 1>* Reform(const blitz::Array<float, 2> &Arr);
    template blitz::Array<double, 1>* Reform(const blitz::Array<double, 2> &Arr);

    template blitz::Array<unsigned short, 2>* Reform(const blitz::Array<unsigned short, 1> &Arr, int DimA, int DimB);
    template blitz::Array<unsigned int, 2>* Reform(const blitz::Array<unsigned int, 1> &Arr, int DimA, int DimB);
    template blitz::Array<int, 2>* Reform(const blitz::Array<int, 1> &Arr, int DimA, int DimB);
    template blitz::Array<long, 2>* Reform(const blitz::Array<long, 1> &Arr, int DimA, int DimB);
    template blitz::Array<float, 2>* Reform(const blitz::Array<float, 1> &Arr, int DimA, int DimB);
    template blitz::Array<double, 2>* Reform(const blitz::Array<double, 1> &Arr, int DimA, int DimB);

    template bool GetSubArrCopy(const blitz::Array<unsigned short, 1> &DA1_In, const blitz::Array<int, 1> &IA1_Indices, blitz::Array<unsigned short, 1> &DA1_Out);
    template bool GetSubArrCopy(const blitz::Array<unsigned int, 1> &DA1_In, const blitz::Array<int, 1> &IA1_Indices, blitz::Array<unsigned int, 1> &DA1_Out);
    template bool GetSubArrCopy(const blitz::Array<int, 1> &DA1_In, const blitz::Array<int, 1> &IA1_Indices, blitz::Array<int, 1> &DA1_Out);
    template bool GetSubArrCopy(const blitz::Array<long, 1> &DA1_In, const blitz::Array<int, 1> &IA1_Indices, blitz::Array<long, 1> &DA1_Out);
    template bool GetSubArrCopy(const blitz::Array<float, 1> &DA1_In, const blitz::Array<int, 1> &IA1_Indices, blitz::Array<float, 1> &DA1_Out);
    template bool GetSubArrCopy(const blitz::Array<double, 1> &DA1_In, const blitz::Array<int, 1> &IA1_Indices, blitz::Array<double, 1> &DA1_Out);

    template bool GetSubArrCopy(const blitz::Array<unsigned short, 2> &A2_In, const blitz::Array<int, 1> &I_A1_Indices, int I_Mode_In, blitz::Array<unsigned short, 2> &A2_Out);
    template bool GetSubArrCopy(const blitz::Array<unsigned int, 2> &A2_In, const blitz::Array<int, 1> &I_A1_Indices, int I_Mode_In, blitz::Array<unsigned int, 2> &A2_Out);
    template bool GetSubArrCopy(const blitz::Array<int, 2> &A2_In, const blitz::Array<int, 1> &I_A1_Indices, int I_Mode_In, blitz::Array<int, 2> &A2_Out);
    template bool GetSubArrCopy(const blitz::Array<long, 2> &A2_In, const blitz::Array<int, 1> &I_A1_Indices, int I_Mode_In, blitz::Array<long, 2> &A2_Out);
    template bool GetSubArrCopy(const blitz::Array<float, 2> &A2_In, const blitz::Array<int, 1> &I_A1_Indices, int I_Mode_In, blitz::Array<float, 2> &A2_Out);
    template bool GetSubArrCopy(const blitz::Array<double, 2> &A2_In, const blitz::Array<int, 1> &I_A1_Indices, int I_Mode_In, blitz::Array<double, 2> &A2_Out);

    template blitz::Array<unsigned short, 2> GetSubArrCopy(const blitz::Array<unsigned short, 2> &A2_In, const blitz::Array<int, 3> &I_A3_Indices);
    template blitz::Array<unsigned int, 2> GetSubArrCopy(const blitz::Array<unsigned int, 2> &A2_In, const blitz::Array<int, 3> &I_A3_Indices);
    template blitz::Array<int, 2> GetSubArrCopy(const blitz::Array<int, 2> &A2_In, const blitz::Array<int, 3> &I_A3_Indices);
    template blitz::Array<long, 2> GetSubArrCopy(const blitz::Array<long, 2> &A2_In, const blitz::Array<int, 3> &I_A3_Indices);
    template blitz::Array<float, 2> GetSubArrCopy(const blitz::Array<float, 2> &A2_In, const blitz::Array<int, 3> &I_A3_Indices);
    template blitz::Array<double, 2> GetSubArrCopy(const blitz::Array<double, 2> &A2_In, const blitz::Array<int, 3> &I_A3_Indices);

    template bool CountPixGTZero(blitz::Array<unsigned short, 1> &vec_InOut);
    template bool CountPixGTZero(blitz::Array<unsigned int, 1> &vec_InOut);
    template bool CountPixGTZero(blitz::Array<int, 1> &vec_InOut);
    template bool CountPixGTZero(blitz::Array<long, 1> &vec_InOut);
    template bool CountPixGTZero(blitz::Array<float, 1> &vec_InOut);
    template bool CountPixGTZero(blitz::Array<double, 1> &vec_InOut);
