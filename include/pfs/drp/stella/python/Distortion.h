...
auto wrapAnalyticDistortion(py::module & mod, char const* name) {
    ...
    cls.def_static("fit", &Class::fit, "order"_a, "range"_a, "x"_a, "y"_a, "xMeas"_a, "yMeas"_a,
                   "xErr"_a, "yErr"_a, "threshold"_a=1.0e-6, "forced"_a=nullptr,
                   "params"_a=nullptr, "xTrace"_a=nullptr, "yTrace"_a=nullptr,
                   "tracePos"_a=nullptr, "tracePosErr"_a=nullptr,
                   "traceSlope"_a=nullptr, "traceSlopeErr"_a=nullptr);
