 ...
 * @param result: structure containing the uncertainties for x plus information about the fit
 */
 ...
 * @param Background: Fit one Gaussian plus background? 0-none, 1-constant, 2-linear background
 * @param B_FitArea: Fit area (YES) or amplitude (No)?
 * @param D_A1_Coeffs_Out: fitted coefficients (output parameter)
 * @param D_A1_ECoeffs_Out: uncertainties of fitted coefficients (output parameter)
 * @param Debug: print out debugging output?
 */
template<typename T>
