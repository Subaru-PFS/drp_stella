...
struct FitProfilesResults {
    ...
    ndarray::Array<double, 3, 1> errors; ///< Errors for profiles
    ...
    FitProfilesResults(
        ...
        ndarray::Array<double, 3, 1> const& errors_,
    ...
    ) : profiles(profiles_), masks(masks_), errors(errors_), backgrounds(backgrounds_), models(models_) {}
};
